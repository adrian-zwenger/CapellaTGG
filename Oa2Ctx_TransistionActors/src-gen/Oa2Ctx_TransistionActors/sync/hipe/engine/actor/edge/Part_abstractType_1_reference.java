...
public class Part_abstractType_1_reference extends GenericReferenceActor<modellingcore.AbstractTypedElement,modellingcore.AbstractType> {
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, ReferenceNode node) {
		...
		ports.add(new PortEdgeLeft(node.getPorts().getPort().get(0), getSelf(), name2actor.get("Oa2Sa_transition_actors_recursively__FWD_97_nacjunction"), this::check_constraint_17 , 0   ));
	}	

	public boolean check_constraint_17(EdgeMatch edge, int index) {
		...
		csp_15.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_operational_entity.getName(), "java.lang.String"));
		csp_15.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_operational_part.getName(), "java.lang.String"));
		csp_15.solve();
