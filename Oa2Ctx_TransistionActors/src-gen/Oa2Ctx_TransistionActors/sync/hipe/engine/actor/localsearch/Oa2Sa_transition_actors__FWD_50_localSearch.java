...
public class Oa2Sa_transition_actors__FWD_50_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.multi_lookup = (o) -> ((org.polarsys.capella.core.data.oa.EntityPkg) o).getOwnedEntities();
						edge_explorer_5_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.polarsys.capella.core.data.oa.EntityPkg) return edge_explorer_5_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_5 = new EdgeExplorer(this, 1, 5, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((modellingcore.AbstractTypedElement) o).getAbstractType(); return (result instanceof org.polarsys.capella.core.data.oa.Entity ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new EdgeExplorer(this, 1, 6, edge_explorer_8_methods);
			...
			case "Oa2Sa_object": 
				{
					...
					// oa2sa
					HMatch match_0 = new LocalSearchMatch("Oa2Sa_transition_actors__FWD_50_localSearch", 7);
			...
			case "EntityPkg_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// src_entity_pkg
						HMatch match_1 = new LocalSearchMatch("Oa2Sa_transition_actors__FWD_50_localSearch", 7);
			...
			case "OperationalAnalysis_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// src_oa_arch
						HMatch match_2 = new LocalSearchMatch("Oa2Sa_transition_actors__FWD_50_localSearch", 7);
			...
			case "SystemComponentPkg_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// trg_componenet_pkg
						HMatch match_3 = new LocalSearchMatch("Oa2Sa_transition_actors__FWD_50_localSearch", 7);
			...
			case "SystemAnalysis_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// trg_sa_arch
						HMatch match_4 = new LocalSearchMatch("Oa2Sa_transition_actors__FWD_50_localSearch", 7);
			...
			case "Entity_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// src_oa_entity
						HMatch match_5 = new LocalSearchMatch("Oa2Sa_transition_actors__FWD_50_localSearch", 7);
			...
			case "Part_object_SP1": 
				{
					...
					// src_oa_part
					HMatch match_6 = new LocalSearchMatch("Oa2Sa_transition_actors__FWD_50_localSearch", 7);
		...
		switch(match.creator) {
			...
			case "Oa2Sa_transition_actors_src_oa_entity_ownedEntities_incoming_SRC__FILTER_NAC_SRC_34_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("Oa2Sa_transition_actors__FWD_50_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("Oa2Sa_transition_actors__FWD_50_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_8.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_entity_pkg.getName(), "java.lang.String"));
		csp_8.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "Operational Entities", "java.lang.String"));
		csp_8.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_9.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_oa_part.getName(), "java.lang.String"));
		csp_9.solve();
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		csp_10.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trg_componenet_pkg.getName(), "java.lang.String"));
		csp_10.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "Structure", "java.lang.String"));
		csp_10.solve();
