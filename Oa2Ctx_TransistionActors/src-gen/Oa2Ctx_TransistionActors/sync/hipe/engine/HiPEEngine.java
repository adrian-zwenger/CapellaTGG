package Oa2Ctx_TransistionActors.sync.hipe.engine;

import akka.actor.ActorRef;
import akka.actor.Props;

import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.NotificationActor;
import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.DispatchActor;
import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.localsearch.Oa2Sa_generation_trg_sa_arch_ownedSystemComponentPkg_outgoing_TRG__FILTER_NAC_TRG_1_localSearch;
import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.localsearch.Oa2Sa_generation__BWD_5_localSearch;
import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.localsearch.Oa2Sa_generation_src_oa_arch_ownedEntityPkg_outgoing_SRC__FILTER_NAC_SRC_10_localSearch;
import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.localsearch.Oa2Sa_generation__CONSISTENCY_14_localSearch;
import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.localsearch.Oa2Sa_generation__FWD_23_localSearch;
import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.localsearch.Oa2Sa_transition_actors__BWD_26_localSearch;
import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.localsearch.Oa2Sa_transition_actors_src_oa_entity_ownedEntities_incoming_SRC__FILTER_NAC_SRC_34_localSearch;
import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.localsearch.Oa2Sa_transition_actors__CONSISTENCY_37_localSearch;
import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.localsearch.Oa2Sa_transition_actors__FWD_50_localSearch;
import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.edge.Part_abstractType_0_reference;
import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.localsearch.Oa2Sa_transition_actors_recursively_src_operational_entity_ownedEntities_incoming_SRC__FILTER_NAC_SRC_71_localSearch;
import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.localsearch.Oa2Sa_transition_actors_recursively_src_operational_part_ownedParts_incoming_SRC__FILTER_NAC_SRC_74_localSearch;
import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.localsearch.Oa2Sa_transition_actors_recursively__CONSISTENCY_77_localSearch;
import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.edge.Part_abstractType_1_reference;
import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.node.SystemAnalysis_object_SP0;
import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.node.SystemComponent_object_SP0;
import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.node.SystemComponent_object_SP1;
import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.node.SystemComponentPkg_object_SP0;
import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.node.SystemComponentPkg_object_SP1;
import Oa2Ctx_TransistionActors.sync.hipe.engine.actor.node.SystemComponentPkg_object_SP2;
...
public class HiPEEngine extends IHiPEEngine{
	...
	public void createJunctionNodes() {
		...
		classes.put("Oa2Sa_generation__FWD_23_localSearch", Oa2Sa_generation__FWD_23_localSearch.class);
		classes.put("Oa2Sa_transition_actors__BWD_26_localSearch", Oa2Sa_transition_actors__BWD_26_localSearch.class);
		classes.put("Oa2Sa_transition_actors_src_oa_entity_ownedEntities_incoming_SRC__FILTER_NAC_SRC_34_localSearch", Oa2Sa_transition_actors_src_oa_entity_ownedEntities_incoming_SRC__FILTER_NAC_SRC_34_localSearch.class);
		classes.put("Oa2Sa_transition_actors__CONSISTENCY_37_localSearch", Oa2Sa_transition_actors__CONSISTENCY_37_localSearch.class);
		classes.put("Oa2Sa_transition_actors__FWD_50_localSearch", Oa2Sa_transition_actors__FWD_50_localSearch.class);
		classes.put("Oa2Sa_transition_actors_recursively__BWD_61_junction", GenericJunctionActor.class);
		classes.put("Oa2Sa_transition_actors_recursively__BWD_62_junction", GenericJunctionActor.class);
		classes.put("Oa2Sa_transition_actors_recursively__BWD_60_junction", GenericJunctionActor.class);
		classes.put("Oa2Sa_transition_actors_recursively__BWD_58_junction", GenericJunctionActor.class);
		classes.put("Oa2Sa_transition_actors_recursively_src_operational_entity_ownedEntities_incoming_SRC__FILTER_NAC_SRC_71_localSearch", Oa2Sa_transition_actors_recursively_src_operational_entity_ownedEntities_incoming_SRC__FILTER_NAC_SRC_71_localSearch.class);
		classes.put("Oa2Sa_transition_actors_recursively_src_operational_part_ownedParts_incoming_SRC__FILTER_NAC_SRC_74_localSearch", Oa2Sa_transition_actors_recursively_src_operational_part_ownedParts_incoming_SRC__FILTER_NAC_SRC_74_localSearch.class);
		classes.put("Oa2Sa_transition_actors_recursively__CONSISTENCY_77_localSearch", Oa2Sa_transition_actors_recursively__CONSISTENCY_77_localSearch.class);
		classes.put("Oa2Sa_transition_actors_recursively__FWD_93_nacjunction", GenericNACJunctionActor.class);
		classes.put("Oa2Sa_transition_actors_recursively__FWD_97_nacjunction", GenericNACJunctionActor.class);
		classes.put("Oa2Sa_transition_actors_recursively__FWD_94_junction", GenericJunctionActor.class);
		classes.put("Oa2Sa_transition_actors_recursively__FWD_90_junction", GenericJunctionActor.class);
		classes.put("Oa2Sa_transition_actors_recursively__FWD_88_junction", GenericJunctionActor.class);
	}
...
class Part_object_SP2 extends GenericObjectActor<org.polarsys.capella.core.data.cs.Part> { }
