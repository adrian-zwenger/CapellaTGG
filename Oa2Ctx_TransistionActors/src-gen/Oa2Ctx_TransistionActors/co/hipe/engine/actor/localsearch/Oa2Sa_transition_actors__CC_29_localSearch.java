package Oa2Ctx_TransistionActors.co.hipe.engine.actor.localsearch;
...
public class Oa2Sa_transition_actors__CC_29_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer = new EdgeExplorer(this, 3, 8, edge_explorer_methods);
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((modellingcore.AbstractTypedElement) o).getAbstractType(); return (result instanceof org.polarsys.capella.core.data.oa.Entity ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 6, 5, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.multi_lookup = (o) -> ((org.polarsys.capella.core.data.cs.ComponentPkg) o).getOwnedParts();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new EdgeExplorer(this, 1, 5, edge_explorer_8_methods);
