package Oa2Ctx_TransistionActors.initfwd.hipe.engine.actor;
...
public class DispatchActor extends AbstractActor {
	...
	private void initializeAdd() {
		...
		type2addConsumer.put(org.polarsys.capella.core.data.ctx.CtxPackage.eINSTANCE.getSystemComponent(), obj -> {
			...
			incUtil.newMessage();
			name2actor.get("SystemComponent_object").tell(new ObjectAdded<org.polarsys.capella.core.data.ctx.SystemComponent>(incUtil, _systemcomponent), getSelf());
		});
	...
	private void initializeSet() {
		feature2setConsumer.put(org.polarsys.capella.core.data.cs.CsPackage.eINSTANCE.getComponent_Actor(), notification -> {
			...
			if(notification.getNotifier() instanceof org.polarsys.capella.core.data.ctx.SystemComponent) {
				incUtil.newMessage();
				name2actor.get("SystemComponent_object").tell(new AttributeChanged<org.polarsys.capella.core.data.cs.Component>(incUtil, (org.polarsys.capella.core.data.cs.Component) notification.getNotifier(), notification.getOldValue()), getSelf());
			}
			if(notification.getNotifier() instanceof org.polarsys.capella.core.data.oa.Entity) {
				incUtil.newMessage();
		...
		feature2setConsumer.put(modellingcore.ModellingcorePackage.eINSTANCE.getAbstractNamedElement_Name(), notification -> {
			...
			if(notification.getNotifier() instanceof org.polarsys.capella.core.data.ctx.SystemComponent) {
				incUtil.newMessage();
				name2actor.get("SystemComponent_object").tell(new AttributeChanged<modellingcore.AbstractNamedElement>(incUtil, (modellingcore.AbstractNamedElement) notification.getNotifier(), notification.getOldValue()), getSelf());
			}
			if(notification.getNotifier() instanceof org.polarsys.capella.core.data.oa.Entity) {
				incUtil.newMessage();
	...
	private void initializeAddEdge() {
		feature2addEdgeConsumer.put(org.polarsys.capella.core.data.oa.OaPackage.eINSTANCE.getOperationalAnalysis_OwnedEntityPkg(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation_src_oa_arch_ownedEntityPkg_outgoing_SRC__FILTER_NAC_SRC_1_localSearch").tell(new ReferenceAdded<org.polarsys.capella.core.data.oa.OperationalAnalysis, org.polarsys.capella.core.data.oa.EntityPkg>(incUtil,(org.polarsys.capella.core.data.oa.OperationalAnalysis) notification.getNotifier(), (org.polarsys.capella.core.data.oa.EntityPkg) notification.getNewValue(), "org.polarsys.capella.core.data.oa.OperationalAnalysis_ownedEntityPkg_EntityPkg"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation_src_oa_arch_ownedEntityPkg_outgoing_SRC__FILTER_NAC_SRC_1_localSearch").tell(new ReferenceAdded<org.polarsys.capella.core.data.oa.OperationalAnalysis, org.polarsys.capella.core.data.oa.EntityPkg>(incUtil,(org.polarsys.capella.core.data.oa.OperationalAnalysis) notification.getNotifier(), (org.polarsys.capella.core.data.oa.EntityPkg) notification.getNewValue(), "org.polarsys.capella.core.data.oa.OperationalAnalysis_ownedEntityPkg_EntityPkg"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__CONSISTENCY_9_localSearch").tell(new ReferenceAdded<org.polarsys.capella.core.data.oa.OperationalAnalysis, org.polarsys.capella.core.data.oa.EntityPkg>(incUtil,(org.polarsys.capella.core.data.oa.OperationalAnalysis) notification.getNotifier(), (org.polarsys.capella.core.data.oa.EntityPkg) notification.getNewValue(), "org.polarsys.capella.core.data.oa.OperationalAnalysis_ownedEntityPkg_EntityPkg"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__FWD_18_localSearch").tell(new ReferenceAdded<org.polarsys.capella.core.data.oa.OperationalAnalysis, org.polarsys.capella.core.data.oa.EntityPkg>(incUtil,(org.polarsys.capella.core.data.oa.OperationalAnalysis) notification.getNotifier(), (org.polarsys.capella.core.data.oa.EntityPkg) notification.getNewValue(), "org.polarsys.capella.core.data.oa.OperationalAnalysis_ownedEntityPkg_EntityPkg"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceAdded<org.polarsys.capella.core.data.oa.OperationalAnalysis, org.polarsys.capella.core.data.oa.EntityPkg>(incUtil,(org.polarsys.capella.core.data.oa.OperationalAnalysis) notification.getNotifier(), (org.polarsys.capella.core.data.oa.EntityPkg) notification.getNewValue(), "org.polarsys.capella.core.data.oa.OperationalAnalysis_ownedEntityPkg_EntityPkg"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__FWD_37_localSearch").tell(new ReferenceAdded<org.polarsys.capella.core.data.oa.OperationalAnalysis, org.polarsys.capella.core.data.oa.EntityPkg>(incUtil,(org.polarsys.capella.core.data.oa.OperationalAnalysis) notification.getNotifier(), (org.polarsys.capella.core.data.oa.EntityPkg) notification.getNewValue(), "org.polarsys.capella.core.data.oa.OperationalAnalysis_ownedEntityPkg_EntityPkg"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors_recursively__Marker_CREATE__TRG__trg_system_component(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker, org.polarsys.capella.core.data.ctx.SystemComponent>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponent) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker_CREATE__TRG__trg_system_component_SystemComponent"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_generation__Marker_CREATE__TRG__trg_sa_arch(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__CONSISTENCY_9_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker, org.polarsys.capella.core.data.ctx.SystemAnalysis>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemAnalysis) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker_CREATE__TRG__trg_sa_arch_SystemAnalysis"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_generation__Marker_CREATE__SRC__src_entity_pkg(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__CONSISTENCY_9_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker, org.polarsys.capella.core.data.oa.EntityPkg>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.oa.EntityPkg) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker_CREATE__SRC__src_entity_pkg_EntityPkg"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors__Marker_CONTEXT__TRG__trg_componenet_pkg(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker, org.polarsys.capella.core.data.ctx.SystemComponentPkg>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponentPkg) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker_CONTEXT__TRG__trg_componenet_pkg_SystemComponentPkg"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors_recursively__Marker_CREATE__CORR__OaEntity2SaSysComponent(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker, Oa2Ctx_TransistionActors.Entity2SystemComponent>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) notification.getNotifier(), (Oa2Ctx_TransistionActors.Entity2SystemComponent) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker_CREATE__CORR__OaEntity2SaSysComponent_Entity2SystemComponent"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getEntity2SystemComponent_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Entity2SystemComponent, org.polarsys.capella.core.data.ctx.SystemComponent>(incUtil,(Oa2Ctx_TransistionActors.Entity2SystemComponent) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponent) notification.getNewValue(), "Oa2Ctx_TransistionActors.Entity2SystemComponent_target_SystemComponent"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Entity2SystemComponent, org.polarsys.capella.core.data.ctx.SystemComponent>(incUtil,(Oa2Ctx_TransistionActors.Entity2SystemComponent) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponent) notification.getNewValue(), "Oa2Ctx_TransistionActors.Entity2SystemComponent_target_SystemComponent"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors_recursively__Marker_CONTEXT__TRG__trg_system_component_pkg(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker, org.polarsys.capella.core.data.ctx.SystemComponentPkg>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponentPkg) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker_CONTEXT__TRG__trg_system_component_pkg_SystemComponentPkg"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors_recursively__Marker_CREATE__CORR__part2part(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker, Oa2Ctx_TransistionActors.OaPart2SaPart>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) notification.getNotifier(), (Oa2Ctx_TransistionActors.OaPart2SaPart) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker_CREATE__CORR__part2part_OaPart2SaPart"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOaPart2SaPart_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.OaPart2SaPart, org.polarsys.capella.core.data.cs.Part>(incUtil,(Oa2Ctx_TransistionActors.OaPart2SaPart) notification.getNotifier(), (org.polarsys.capella.core.data.cs.Part) notification.getNewValue(), "Oa2Ctx_TransistionActors.OaPart2SaPart_source_Part"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.OaPart2SaPart, org.polarsys.capella.core.data.cs.Part>(incUtil,(Oa2Ctx_TransistionActors.OaPart2SaPart) notification.getNotifier(), (org.polarsys.capella.core.data.cs.Part) notification.getNewValue(), "Oa2Ctx_TransistionActors.OaPart2SaPart_source_Part"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors_recursively__Marker_CREATE__TRG__trg_system_part(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker, org.polarsys.capella.core.data.cs.Part>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.cs.Part) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker_CREATE__TRG__trg_system_part_Part"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_generation__Marker_CREATE__TRG__trg_system_as_component(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__CONSISTENCY_9_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker, org.polarsys.capella.core.data.ctx.SystemComponent>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponent) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker_CREATE__TRG__trg_system_as_component_SystemComponent"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors__Marker_CONTEXT__TRG__trg_sa_arch(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker, org.polarsys.capella.core.data.ctx.SystemAnalysis>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemAnalysis) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker_CONTEXT__TRG__trg_sa_arch_SystemAnalysis"), getSelf());
		});
		feature2addEdgeConsumer.put(org.polarsys.capella.core.data.cs.CsPackage.eINSTANCE.getComponentPkg_OwnedParts(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__CONSISTENCY_9_localSearch").tell(new ReferenceAdded<org.polarsys.capella.core.data.cs.ComponentPkg, org.polarsys.capella.core.data.cs.Part>(incUtil,(org.polarsys.capella.core.data.cs.ComponentPkg) notification.getNotifier(), (org.polarsys.capella.core.data.cs.Part) notification.getNewValue(), "org.polarsys.capella.core.data.cs.ComponentPkg_ownedParts_Part"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceAdded<org.polarsys.capella.core.data.cs.ComponentPkg, org.polarsys.capella.core.data.cs.Part>(incUtil,(org.polarsys.capella.core.data.cs.ComponentPkg) notification.getNotifier(), (org.polarsys.capella.core.data.cs.Part) notification.getNewValue(), "org.polarsys.capella.core.data.cs.ComponentPkg_ownedParts_Part"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__FWD_37_localSearch").tell(new ReferenceAdded<org.polarsys.capella.core.data.cs.ComponentPkg, org.polarsys.capella.core.data.cs.Part>(incUtil,(org.polarsys.capella.core.data.cs.ComponentPkg) notification.getNotifier(), (org.polarsys.capella.core.data.cs.Part) notification.getNewValue(), "org.polarsys.capella.core.data.cs.ComponentPkg_ownedParts_Part"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively_src_operational_part_ownedParts_incoming_SRC__FILTER_NAC_SRC_48_localSearch").tell(new ReferenceAdded<org.polarsys.capella.core.data.cs.ComponentPkg, org.polarsys.capella.core.data.cs.Part>(incUtil,(org.polarsys.capella.core.data.cs.ComponentPkg) notification.getNotifier(), (org.polarsys.capella.core.data.cs.Part) notification.getNewValue(), "org.polarsys.capella.core.data.cs.ComponentPkg_ownedParts_Part"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceAdded<org.polarsys.capella.core.data.cs.ComponentPkg, org.polarsys.capella.core.data.cs.Part>(incUtil,(org.polarsys.capella.core.data.cs.ComponentPkg) notification.getNotifier(), (org.polarsys.capella.core.data.cs.Part) notification.getNewValue(), "org.polarsys.capella.core.data.cs.ComponentPkg_ownedParts_Part"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_generation__Marker_CREATE__CORR__new_oa2sa(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__CONSISTENCY_9_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker, Oa2Ctx_TransistionActors.Oa2Sa>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker) notification.getNotifier(), (Oa2Ctx_TransistionActors.Oa2Sa) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker_CREATE__CORR__new_oa2sa_Oa2Sa"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors__Marker_CREATE__CORR__entity2component(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker, Oa2Ctx_TransistionActors.Entity2SystemComponent>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) notification.getNotifier(), (Oa2Ctx_TransistionActors.Entity2SystemComponent) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker_CREATE__CORR__entity2component_Entity2SystemComponent"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getEntity2SystemComponent_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Entity2SystemComponent, org.polarsys.capella.core.data.oa.Entity>(incUtil,(Oa2Ctx_TransistionActors.Entity2SystemComponent) notification.getNotifier(), (org.polarsys.capella.core.data.oa.Entity) notification.getNewValue(), "Oa2Ctx_TransistionActors.Entity2SystemComponent_source_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Entity2SystemComponent, org.polarsys.capella.core.data.oa.Entity>(incUtil,(Oa2Ctx_TransistionActors.Entity2SystemComponent) notification.getNotifier(), (org.polarsys.capella.core.data.oa.Entity) notification.getNewValue(), "Oa2Ctx_TransistionActors.Entity2SystemComponent_source_Entity"), getSelf());
		});
		feature2addEdgeConsumer.put(org.polarsys.capella.core.data.ctx.CtxPackage.eINSTANCE.getSystemAnalysis_OwnedSystemComponentPkg(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation_trg_sa_arch_ownedSystemComponentPkg_outgoing_TRG__FILTER_NAC_TRG_5_localSearch").tell(new ReferenceAdded<org.polarsys.capella.core.data.ctx.SystemAnalysis, org.polarsys.capella.core.data.ctx.SystemComponentPkg>(incUtil,(org.polarsys.capella.core.data.ctx.SystemAnalysis) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponentPkg) notification.getNewValue(), "org.polarsys.capella.core.data.ctx.SystemAnalysis_ownedSystemComponentPkg_SystemComponentPkg"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation_trg_sa_arch_ownedSystemComponentPkg_outgoing_TRG__FILTER_NAC_TRG_5_localSearch").tell(new ReferenceAdded<org.polarsys.capella.core.data.ctx.SystemAnalysis, org.polarsys.capella.core.data.ctx.SystemComponentPkg>(incUtil,(org.polarsys.capella.core.data.ctx.SystemAnalysis) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponentPkg) notification.getNewValue(), "org.polarsys.capella.core.data.ctx.SystemAnalysis_ownedSystemComponentPkg_SystemComponentPkg"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__CONSISTENCY_9_localSearch").tell(new ReferenceAdded<org.polarsys.capella.core.data.ctx.SystemAnalysis, org.polarsys.capella.core.data.ctx.SystemComponentPkg>(incUtil,(org.polarsys.capella.core.data.ctx.SystemAnalysis) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponentPkg) notification.getNewValue(), "org.polarsys.capella.core.data.ctx.SystemAnalysis_ownedSystemComponentPkg_SystemComponentPkg"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceAdded<org.polarsys.capella.core.data.ctx.SystemAnalysis, org.polarsys.capella.core.data.ctx.SystemComponentPkg>(incUtil,(org.polarsys.capella.core.data.ctx.SystemAnalysis) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponentPkg) notification.getNewValue(), "org.polarsys.capella.core.data.ctx.SystemAnalysis_ownedSystemComponentPkg_SystemComponentPkg"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__FWD_37_localSearch").tell(new ReferenceAdded<org.polarsys.capella.core.data.ctx.SystemAnalysis, org.polarsys.capella.core.data.ctx.SystemComponentPkg>(incUtil,(org.polarsys.capella.core.data.ctx.SystemAnalysis) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponentPkg) notification.getNewValue(), "org.polarsys.capella.core.data.ctx.SystemAnalysis_ownedSystemComponentPkg_SystemComponentPkg"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceAdded<org.polarsys.capella.core.data.ctx.SystemAnalysis, org.polarsys.capella.core.data.ctx.SystemComponentPkg>(incUtil,(org.polarsys.capella.core.data.ctx.SystemAnalysis) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponentPkg) notification.getNewValue(), "org.polarsys.capella.core.data.ctx.SystemAnalysis_ownedSystemComponentPkg_SystemComponentPkg"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors__Marker_CREATE__TRG__trg_sys_component(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker, org.polarsys.capella.core.data.ctx.SystemComponent>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponent) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker_CREATE__TRG__trg_sys_component_SystemComponent"), getSelf());
		});
		feature2addEdgeConsumer.put(org.polarsys.capella.core.data.oa.OaPackage.eINSTANCE.getEntityPkg_OwnedEntities(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__FWD_37_localSearch").tell(new ReferenceAdded<org.polarsys.capella.core.data.oa.EntityPkg, org.polarsys.capella.core.data.oa.Entity>(incUtil,(org.polarsys.capella.core.data.oa.EntityPkg) notification.getNotifier(), (org.polarsys.capella.core.data.oa.Entity) notification.getNewValue(), "org.polarsys.capella.core.data.oa.EntityPkg_ownedEntities_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively_src_operational_entity_ownedEntities_incoming_SRC__FILTER_NAC_SRC_45_localSearch").tell(new ReferenceAdded<org.polarsys.capella.core.data.oa.EntityPkg, org.polarsys.capella.core.data.oa.Entity>(incUtil,(org.polarsys.capella.core.data.oa.EntityPkg) notification.getNotifier(), (org.polarsys.capella.core.data.oa.Entity) notification.getNewValue(), "org.polarsys.capella.core.data.oa.EntityPkg_ownedEntities_Entity"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors__Marker_CREATE__SRC__src_oa_part(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker, org.polarsys.capella.core.data.cs.Part>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.cs.Part) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker_CREATE__SRC__src_oa_part_Part"), getSelf());
		});
		feature2addEdgeConsumer.put(org.polarsys.capella.core.data.ctx.CtxPackage.eINSTANCE.getSystemComponentPkg_OwnedSystemComponents(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__CONSISTENCY_9_localSearch").tell(new ReferenceAdded<org.polarsys.capella.core.data.ctx.SystemComponentPkg, org.polarsys.capella.core.data.ctx.SystemComponent>(incUtil,(org.polarsys.capella.core.data.ctx.SystemComponentPkg) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponent) notification.getNewValue(), "org.polarsys.capella.core.data.ctx.SystemComponentPkg_ownedSystemComponents_SystemComponent"), getSelf());
			incUtil.newMessage();
		...
		feature2addEdgeConsumer.put(modellingcore.ModellingcorePackage.eINSTANCE.getAbstractTypedElement_AbstractType(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__CONSISTENCY_9_localSearch").tell(new ReferenceAdded<modellingcore.AbstractTypedElement, modellingcore.AbstractType>(incUtil,(modellingcore.AbstractTypedElement) notification.getNotifier(), (modellingcore.AbstractType) notification.getNewValue(), "modellingcore.AbstractTypedElement_abstractType_AbstractType"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceAdded<modellingcore.AbstractTypedElement, modellingcore.AbstractType>(incUtil,(modellingcore.AbstractTypedElement) notification.getNotifier(), (modellingcore.AbstractType) notification.getNewValue(), "modellingcore.AbstractTypedElement_abstractType_AbstractType"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__FWD_37_localSearch").tell(new ReferenceAdded<modellingcore.AbstractTypedElement, modellingcore.AbstractType>(incUtil,(modellingcore.AbstractTypedElement) notification.getNotifier(), (modellingcore.AbstractType) notification.getNewValue(), "modellingcore.AbstractTypedElement_abstractType_AbstractType"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceAdded<modellingcore.AbstractTypedElement, modellingcore.AbstractType>(incUtil,(modellingcore.AbstractTypedElement) notification.getNotifier(), (modellingcore.AbstractType) notification.getNewValue(), "modellingcore.AbstractTypedElement_abstractType_AbstractType"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceAdded<modellingcore.AbstractTypedElement, modellingcore.AbstractType>(incUtil,(modellingcore.AbstractTypedElement) notification.getNotifier(), (modellingcore.AbstractType) notification.getNewValue(), "modellingcore.AbstractTypedElement_abstractType_AbstractType"), getSelf());
		...
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors__Marker_CREATE__CORR__part2part(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker, Oa2Ctx_TransistionActors.OaPart2SaPart>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) notification.getNotifier(), (Oa2Ctx_TransistionActors.OaPart2SaPart) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker_CREATE__CORR__part2part_OaPart2SaPart"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors__Marker_CONTEXT__CORR__oa2sa(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker, Oa2Ctx_TransistionActors.Oa2Sa>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) notification.getNotifier(), (Oa2Ctx_TransistionActors.Oa2Sa) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker_CONTEXT__CORR__oa2sa_Oa2Sa"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_generation__Marker_CREATE__TRG__trg_system_component_pkg(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__CONSISTENCY_9_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker, org.polarsys.capella.core.data.ctx.SystemComponentPkg>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponentPkg) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker_CREATE__TRG__trg_system_component_pkg_SystemComponentPkg"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors_recursively__Marker_CREATE__SRC__src_operational_part(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker, org.polarsys.capella.core.data.cs.Part>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.cs.Part) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker_CREATE__SRC__src_operational_part_Part"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors_recursively__Marker_CONTEXT__TRG__trg_sa_arch(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker, org.polarsys.capella.core.data.ctx.SystemAnalysis>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemAnalysis) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker_CONTEXT__TRG__trg_sa_arch_SystemAnalysis"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors__Marker_CREATE__SRC__src_oa_entity(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker, org.polarsys.capella.core.data.oa.Entity>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.oa.Entity) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker_CREATE__SRC__src_oa_entity_Entity"), getSelf());
		});
		feature2addEdgeConsumer.put(org.polarsys.capella.core.data.capellacore.CapellacorePackage.eINSTANCE.getClassifier_OwnedFeatures(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceAdded<org.polarsys.capella.core.data.capellacore.Classifier, org.polarsys.capella.core.data.capellacore.Feature>(incUtil,(org.polarsys.capella.core.data.capellacore.Classifier) notification.getNotifier(), (org.polarsys.capella.core.data.capellacore.Feature) notification.getNewValue(), "org.polarsys.capella.core.data.capellacore.Classifier_ownedFeatures_Feature"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_generation__Marker_CREATE__TRG__trg_system_as_part(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__CONSISTENCY_9_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker, org.polarsys.capella.core.data.cs.Part>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.cs.Part) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker_CREATE__TRG__trg_system_as_part_Part"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors_recursively__Marker_CONTEXT__SRC__src_top_level_entity(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker, org.polarsys.capella.core.data.oa.Entity>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.oa.Entity) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker_CONTEXT__SRC__src_top_level_entity_Entity"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOaPart2SaPart_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.OaPart2SaPart, org.polarsys.capella.core.data.cs.Part>(incUtil,(Oa2Ctx_TransistionActors.OaPart2SaPart) notification.getNotifier(), (org.polarsys.capella.core.data.cs.Part) notification.getNewValue(), "Oa2Ctx_TransistionActors.OaPart2SaPart_target_Part"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.OaPart2SaPart, org.polarsys.capella.core.data.cs.Part>(incUtil,(Oa2Ctx_TransistionActors.OaPart2SaPart) notification.getNotifier(), (org.polarsys.capella.core.data.cs.Part) notification.getNewValue(), "Oa2Ctx_TransistionActors.OaPart2SaPart_target_Part"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors__Marker_CONTEXT__SRC__src_entity_pkg(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker, org.polarsys.capella.core.data.oa.EntityPkg>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.oa.EntityPkg) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker_CONTEXT__SRC__src_entity_pkg_EntityPkg"), getSelf());
		});
		feature2addEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors_recursively__Marker_CREATE__SRC__src_operational_entity(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceAdded<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker, org.polarsys.capella.core.data.oa.Entity>(incUtil,(Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.oa.Entity) notification.getNewValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker_CREATE__SRC__src_operational_entity_Entity"), getSelf());
		});
	}
	...
	private void initializeRemoveEdge() {
		feature2removeEdgeConsumer.put(org.polarsys.capella.core.data.oa.OaPackage.eINSTANCE.getOperationalAnalysis_OwnedEntityPkg(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation_src_oa_arch_ownedEntityPkg_outgoing_SRC__FILTER_NAC_SRC_1_localSearch").tell(new ReferenceDeleted<org.polarsys.capella.core.data.oa.OperationalAnalysis, org.polarsys.capella.core.data.oa.EntityPkg>(incUtil, (org.polarsys.capella.core.data.oa.OperationalAnalysis) notification.getNotifier(), (org.polarsys.capella.core.data.oa.EntityPkg) notification.getOldValue(), "org.polarsys.capella.core.data.oa.OperationalAnalysis_ownedEntityPkg_EntityPkg"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation_src_oa_arch_ownedEntityPkg_outgoing_SRC__FILTER_NAC_SRC_1_localSearch").tell(new ReferenceDeleted<org.polarsys.capella.core.data.oa.OperationalAnalysis, org.polarsys.capella.core.data.oa.EntityPkg>(incUtil, (org.polarsys.capella.core.data.oa.OperationalAnalysis) notification.getNotifier(), (org.polarsys.capella.core.data.oa.EntityPkg) notification.getOldValue(), "org.polarsys.capella.core.data.oa.OperationalAnalysis_ownedEntityPkg_EntityPkg"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__CONSISTENCY_9_localSearch").tell(new ReferenceDeleted<org.polarsys.capella.core.data.oa.OperationalAnalysis, org.polarsys.capella.core.data.oa.EntityPkg>(incUtil, (org.polarsys.capella.core.data.oa.OperationalAnalysis) notification.getNotifier(), (org.polarsys.capella.core.data.oa.EntityPkg) notification.getOldValue(), "org.polarsys.capella.core.data.oa.OperationalAnalysis_ownedEntityPkg_EntityPkg"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__FWD_18_localSearch").tell(new ReferenceDeleted<org.polarsys.capella.core.data.oa.OperationalAnalysis, org.polarsys.capella.core.data.oa.EntityPkg>(incUtil, (org.polarsys.capella.core.data.oa.OperationalAnalysis) notification.getNotifier(), (org.polarsys.capella.core.data.oa.EntityPkg) notification.getOldValue(), "org.polarsys.capella.core.data.oa.OperationalAnalysis_ownedEntityPkg_EntityPkg"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceDeleted<org.polarsys.capella.core.data.oa.OperationalAnalysis, org.polarsys.capella.core.data.oa.EntityPkg>(incUtil, (org.polarsys.capella.core.data.oa.OperationalAnalysis) notification.getNotifier(), (org.polarsys.capella.core.data.oa.EntityPkg) notification.getOldValue(), "org.polarsys.capella.core.data.oa.OperationalAnalysis_ownedEntityPkg_EntityPkg"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__FWD_37_localSearch").tell(new ReferenceDeleted<org.polarsys.capella.core.data.oa.OperationalAnalysis, org.polarsys.capella.core.data.oa.EntityPkg>(incUtil, (org.polarsys.capella.core.data.oa.OperationalAnalysis) notification.getNotifier(), (org.polarsys.capella.core.data.oa.EntityPkg) notification.getOldValue(), "org.polarsys.capella.core.data.oa.OperationalAnalysis_ownedEntityPkg_EntityPkg"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors_recursively__Marker_CREATE__TRG__trg_system_component(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker, org.polarsys.capella.core.data.ctx.SystemComponent>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponent) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker_CREATE__TRG__trg_system_component_SystemComponent"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_generation__Marker_CREATE__TRG__trg_sa_arch(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__CONSISTENCY_9_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker, org.polarsys.capella.core.data.ctx.SystemAnalysis>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemAnalysis) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker_CREATE__TRG__trg_sa_arch_SystemAnalysis"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_generation__Marker_CREATE__SRC__src_entity_pkg(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__CONSISTENCY_9_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker, org.polarsys.capella.core.data.oa.EntityPkg>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.oa.EntityPkg) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker_CREATE__SRC__src_entity_pkg_EntityPkg"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors__Marker_CONTEXT__TRG__trg_componenet_pkg(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker, org.polarsys.capella.core.data.ctx.SystemComponentPkg>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponentPkg) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker_CONTEXT__TRG__trg_componenet_pkg_SystemComponentPkg"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors_recursively__Marker_CREATE__CORR__OaEntity2SaSysComponent(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker, Oa2Ctx_TransistionActors.Entity2SystemComponent>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) notification.getNotifier(), (Oa2Ctx_TransistionActors.Entity2SystemComponent) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker_CREATE__CORR__OaEntity2SaSysComponent_Entity2SystemComponent"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getEntity2SystemComponent_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Entity2SystemComponent, org.polarsys.capella.core.data.ctx.SystemComponent>(incUtil, (Oa2Ctx_TransistionActors.Entity2SystemComponent) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponent) notification.getOldValue(), "Oa2Ctx_TransistionActors.Entity2SystemComponent_target_SystemComponent"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Entity2SystemComponent, org.polarsys.capella.core.data.ctx.SystemComponent>(incUtil, (Oa2Ctx_TransistionActors.Entity2SystemComponent) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponent) notification.getOldValue(), "Oa2Ctx_TransistionActors.Entity2SystemComponent_target_SystemComponent"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors_recursively__Marker_CONTEXT__TRG__trg_system_component_pkg(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker, org.polarsys.capella.core.data.ctx.SystemComponentPkg>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponentPkg) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker_CONTEXT__TRG__trg_system_component_pkg_SystemComponentPkg"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors_recursively__Marker_CREATE__CORR__part2part(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker, Oa2Ctx_TransistionActors.OaPart2SaPart>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) notification.getNotifier(), (Oa2Ctx_TransistionActors.OaPart2SaPart) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker_CREATE__CORR__part2part_OaPart2SaPart"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOaPart2SaPart_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.OaPart2SaPart, org.polarsys.capella.core.data.cs.Part>(incUtil, (Oa2Ctx_TransistionActors.OaPart2SaPart) notification.getNotifier(), (org.polarsys.capella.core.data.cs.Part) notification.getOldValue(), "Oa2Ctx_TransistionActors.OaPart2SaPart_source_Part"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.OaPart2SaPart, org.polarsys.capella.core.data.cs.Part>(incUtil, (Oa2Ctx_TransistionActors.OaPart2SaPart) notification.getNotifier(), (org.polarsys.capella.core.data.cs.Part) notification.getOldValue(), "Oa2Ctx_TransistionActors.OaPart2SaPart_source_Part"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors_recursively__Marker_CREATE__TRG__trg_system_part(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker, org.polarsys.capella.core.data.cs.Part>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.cs.Part) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker_CREATE__TRG__trg_system_part_Part"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_generation__Marker_CREATE__TRG__trg_system_as_component(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__CONSISTENCY_9_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker, org.polarsys.capella.core.data.ctx.SystemComponent>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponent) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker_CREATE__TRG__trg_system_as_component_SystemComponent"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors__Marker_CONTEXT__TRG__trg_sa_arch(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker, org.polarsys.capella.core.data.ctx.SystemAnalysis>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemAnalysis) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker_CONTEXT__TRG__trg_sa_arch_SystemAnalysis"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_generation__Marker_CREATE__CORR__new_oa2sa(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__CONSISTENCY_9_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker, Oa2Ctx_TransistionActors.Oa2Sa>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker) notification.getNotifier(), (Oa2Ctx_TransistionActors.Oa2Sa) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker_CREATE__CORR__new_oa2sa_Oa2Sa"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors__Marker_CREATE__CORR__entity2component(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker, Oa2Ctx_TransistionActors.Entity2SystemComponent>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) notification.getNotifier(), (Oa2Ctx_TransistionActors.Entity2SystemComponent) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker_CREATE__CORR__entity2component_Entity2SystemComponent"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_generation__Marker_CREATE__SRC__src_oa_arch(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__CONSISTENCY_9_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker, org.polarsys.capella.core.data.oa.OperationalAnalysis>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.oa.OperationalAnalysis) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker_CREATE__SRC__src_oa_arch_OperationalAnalysis"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getEntity2SystemComponent_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Entity2SystemComponent, org.polarsys.capella.core.data.oa.Entity>(incUtil, (Oa2Ctx_TransistionActors.Entity2SystemComponent) notification.getNotifier(), (org.polarsys.capella.core.data.oa.Entity) notification.getOldValue(), "Oa2Ctx_TransistionActors.Entity2SystemComponent_source_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Entity2SystemComponent, org.polarsys.capella.core.data.oa.Entity>(incUtil, (Oa2Ctx_TransistionActors.Entity2SystemComponent) notification.getNotifier(), (org.polarsys.capella.core.data.oa.Entity) notification.getOldValue(), "Oa2Ctx_TransistionActors.Entity2SystemComponent_source_Entity"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors__Marker_CREATE__TRG__trg_sys_component(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker, org.polarsys.capella.core.data.ctx.SystemComponent>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponent) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker_CREATE__TRG__trg_sys_component_SystemComponent"), getSelf());
		});
		feature2removeEdgeConsumer.put(org.polarsys.capella.core.data.oa.OaPackage.eINSTANCE.getEntityPkg_OwnedEntities(), notification -> {
			...
			name2actor.get("Oa2Sa_transition_actors__FWD_37_localSearch").tell(new ReferenceDeleted<org.polarsys.capella.core.data.oa.EntityPkg, org.polarsys.capella.core.data.oa.Entity>(incUtil, (org.polarsys.capella.core.data.oa.EntityPkg) notification.getNotifier(), (org.polarsys.capella.core.data.oa.Entity) notification.getOldValue(), "org.polarsys.capella.core.data.oa.EntityPkg_ownedEntities_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively_src_operational_entity_ownedEntities_incoming_SRC__FILTER_NAC_SRC_45_localSearch").tell(new ReferenceDeleted<org.polarsys.capella.core.data.oa.EntityPkg, org.polarsys.capella.core.data.oa.Entity>(incUtil, (org.polarsys.capella.core.data.oa.EntityPkg) notification.getNotifier(), (org.polarsys.capella.core.data.oa.Entity) notification.getOldValue(), "org.polarsys.capella.core.data.oa.EntityPkg_ownedEntities_Entity"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors__Marker_CREATE__SRC__src_oa_part(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker, org.polarsys.capella.core.data.cs.Part>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.cs.Part) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker_CREATE__SRC__src_oa_part_Part"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(modellingcore.ModellingcorePackage.eINSTANCE.getAbstractTypedElement_AbstractType(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__CONSISTENCY_9_localSearch").tell(new ReferenceDeleted<modellingcore.AbstractTypedElement, modellingcore.AbstractType>(incUtil, (modellingcore.AbstractTypedElement) notification.getNotifier(), (modellingcore.AbstractType) notification.getOldValue(), "modellingcore.AbstractTypedElement_abstractType_AbstractType"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceDeleted<modellingcore.AbstractTypedElement, modellingcore.AbstractType>(incUtil, (modellingcore.AbstractTypedElement) notification.getNotifier(), (modellingcore.AbstractType) notification.getOldValue(), "modellingcore.AbstractTypedElement_abstractType_AbstractType"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__FWD_37_localSearch").tell(new ReferenceDeleted<modellingcore.AbstractTypedElement, modellingcore.AbstractType>(incUtil, (modellingcore.AbstractTypedElement) notification.getNotifier(), (modellingcore.AbstractType) notification.getOldValue(), "modellingcore.AbstractTypedElement_abstractType_AbstractType"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceDeleted<modellingcore.AbstractTypedElement, modellingcore.AbstractType>(incUtil, (modellingcore.AbstractTypedElement) notification.getNotifier(), (modellingcore.AbstractType) notification.getOldValue(), "modellingcore.AbstractTypedElement_abstractType_AbstractType"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceDeleted<modellingcore.AbstractTypedElement, modellingcore.AbstractType>(incUtil, (modellingcore.AbstractTypedElement) notification.getNotifier(), (modellingcore.AbstractType) notification.getOldValue(), "modellingcore.AbstractTypedElement_abstractType_AbstractType"), getSelf());
		...
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors__Marker_CREATE__CORR__part2part(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker, Oa2Ctx_TransistionActors.OaPart2SaPart>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) notification.getNotifier(), (Oa2Ctx_TransistionActors.OaPart2SaPart) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker_CREATE__CORR__part2part_OaPart2SaPart"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors__Marker_CONTEXT__CORR__oa2sa(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker, Oa2Ctx_TransistionActors.Oa2Sa>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) notification.getNotifier(), (Oa2Ctx_TransistionActors.Oa2Sa) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker_CONTEXT__CORR__oa2sa_Oa2Sa"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_generation__Marker_CREATE__TRG__trg_system_component_pkg(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__CONSISTENCY_9_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker, org.polarsys.capella.core.data.ctx.SystemComponentPkg>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemComponentPkg) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker_CREATE__TRG__trg_system_component_pkg_SystemComponentPkg"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors_recursively__Marker_CREATE__SRC__src_operational_part(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker, org.polarsys.capella.core.data.cs.Part>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.cs.Part) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker_CREATE__SRC__src_operational_part_Part"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors_recursively__Marker_CONTEXT__TRG__trg_sa_arch(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker, org.polarsys.capella.core.data.ctx.SystemAnalysis>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.ctx.SystemAnalysis) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker_CONTEXT__TRG__trg_sa_arch_SystemAnalysis"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors__Marker_CREATE__SRC__src_oa_entity(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker, org.polarsys.capella.core.data.oa.Entity>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.oa.Entity) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker_CREATE__SRC__src_oa_entity_Entity"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_generation__Marker_CREATE__TRG__trg_system_as_part(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_generation__CONSISTENCY_9_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker, org.polarsys.capella.core.data.cs.Part>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.cs.Part) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker_CREATE__TRG__trg_system_as_part_Part"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors_recursively__Marker_CONTEXT__SRC__src_top_level_entity(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker, org.polarsys.capella.core.data.oa.Entity>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.oa.Entity) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker_CONTEXT__SRC__src_top_level_entity_Entity"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors__Marker_CONTEXT__SRC__src_oa_arch(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker, org.polarsys.capella.core.data.oa.OperationalAnalysis>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.oa.OperationalAnalysis) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker_CONTEXT__SRC__src_oa_arch_OperationalAnalysis"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOaPart2SaPart_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.OaPart2SaPart, org.polarsys.capella.core.data.cs.Part>(incUtil, (Oa2Ctx_TransistionActors.OaPart2SaPart) notification.getNotifier(), (org.polarsys.capella.core.data.cs.Part) notification.getOldValue(), "Oa2Ctx_TransistionActors.OaPart2SaPart_target_Part"), getSelf());
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.OaPart2SaPart, org.polarsys.capella.core.data.cs.Part>(incUtil, (Oa2Ctx_TransistionActors.OaPart2SaPart) notification.getNotifier(), (org.polarsys.capella.core.data.cs.Part) notification.getOldValue(), "Oa2Ctx_TransistionActors.OaPart2SaPart_target_Part"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors__Marker_CONTEXT__SRC__src_entity_pkg(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker, org.polarsys.capella.core.data.oa.EntityPkg>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.oa.EntityPkg) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker_CONTEXT__SRC__src_entity_pkg_EntityPkg"), getSelf());
		});
		feature2removeEdgeConsumer.put(Oa2Ctx_TransistionActors.Oa2Ctx_TransistionActorsPackage.eINSTANCE.getOa2Sa_transition_actors_recursively__Marker_CREATE__SRC__src_operational_entity(), notification -> {
			incUtil.newMessage();
			name2actor.get("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch").tell(new ReferenceDeleted<Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker, org.polarsys.capella.core.data.oa.Entity>(incUtil, (Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) notification.getNotifier(), (org.polarsys.capella.core.data.oa.Entity) notification.getOldValue(), "Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker_CREATE__SRC__src_operational_entity_Entity"), getSelf());
		});
	}
	...
	private void handleRemoveAdapter(Notification notification) {
		...
		if (node instanceof org.polarsys.capella.core.data.ctx.SystemComponent) {
			incUtil.newMessage();
			name2actor.get("SystemComponent_object").tell(new ObjectDeleted<org.polarsys.capella.core.data.ctx.SystemComponent>(incUtil, (org.polarsys.capella.core.data.ctx.SystemComponent) node), getSelf());
		}
