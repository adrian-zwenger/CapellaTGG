...
public class Oa2Sa_transition_actors__CONSISTENCY_24_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((modellingcore.AbstractTypedElement) o).getAbstractType(); return (result instanceof org.polarsys.capella.core.data.oa.Entity ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 3, 2, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((modellingcore.AbstractTypedElement) o).getAbstractType(); return (result instanceof org.polarsys.capella.core.data.ctx.SystemComponent ? result : null);};
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) o).getCREATE__CORR__entity2component();
						edge_explorer_5 = new CachedEdgeExplorer(this, 11, 8, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.OaPart2SaPart) o).getTarget();
						edge_explorer_7 = new CachedEdgeExplorer(this, 10, 7, edge_explorer_7_methods);
		name2explorer.put("edge_explorer_7", edge_explorer_7);
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) o).getCONTEXT__SRC__src_oa_arch();
						edge_explorer_8 = new CachedEdgeExplorer(this, 11, 1, edge_explorer_8_methods);
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) o).getCREATE__TRG__trg_sys_part();
						edge_explorer_10 = new CachedEdgeExplorer(this, 11, 7, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.multi_lookup = (o) -> ((org.polarsys.capella.core.data.oa.EntityPkg) o).getOwnedEntities();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) o).getCREATE__SRC__src_oa_part();
						edge_explorer_12 = new CachedEdgeExplorer(this, 11, 3, edge_explorer_12_methods);
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.multi_lookup = (o) -> ((org.polarsys.capella.core.data.ctx.SystemComponentPkg) o).getOwnedSystemComponents();
						...
						edge_explorer_14 = new EdgeExplorer(this, 4, 6, edge_explorer_14_methods);
		name2explorer.put("edge_explorer_14", edge_explorer_14);
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.OaPart2SaPart) o).getSource();
						edge_explorer_15 = new CachedEdgeExplorer(this, 10, 3, edge_explorer_15_methods);
		name2explorer.put("edge_explorer_15", edge_explorer_15);
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.multi_lookup = (o) -> ((org.polarsys.capella.core.data.cs.ComponentPkg) o).getOwnedParts();
						edge_explorer_16_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.polarsys.capella.core.data.oa.EntityPkg) return edge_explorer_16_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) o).getCONTEXT__SRC__src_entity_pkg();
						edge_explorer_17 = new CachedEdgeExplorer(this, 11, 0, edge_explorer_17_methods);
		...
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						...
						edge_explorer_18 = new CachedEdgeExplorer(this, 8, 6, edge_explorer_18_methods);
		name2explorer.put("edge_explorer_18", edge_explorer_18);
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa) o).getSource();
		...
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) o).getCONTEXT__CORR__oa2sa();
						edge_explorer_20 = new CachedEdgeExplorer(this, 11, 9, edge_explorer_20_methods);
		name2explorer.put("edge_explorer_20", edge_explorer_20);
		EdgeLookupMethods edge_explorer_21_methods = new EdgeLookupMethods();
						edge_explorer_21_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) o).getCREATE__CORR__part2part();
						edge_explorer_21 = new CachedEdgeExplorer(this, 11, 10, edge_explorer_21_methods);
		name2explorer.put("edge_explorer_21", edge_explorer_21);
		EdgeLookupMethods edge_explorer_22_methods = new EdgeLookupMethods();
						edge_explorer_22_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) o).getCONTEXT__TRG__trg_sa_arch();
						edge_explorer_22 = new CachedEdgeExplorer(this, 11, 5, edge_explorer_22_methods);
		name2explorer.put("edge_explorer_22", edge_explorer_22);
		EdgeLookupMethods edge_explorer_23_methods = new EdgeLookupMethods();
						edge_explorer_23_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) o).getCREATE__SRC__src_oa_entity();
						edge_explorer_23 = new CachedEdgeExplorer(this, 11, 2, edge_explorer_23_methods);
		name2explorer.put("edge_explorer_23", edge_explorer_23);
		EdgeLookupMethods edge_explorer_24_methods = new EdgeLookupMethods();
						edge_explorer_24_methods.multi_lookup = (o) -> ((org.polarsys.capella.core.data.cs.ComponentPkg) o).getOwnedParts();
						edge_explorer_24_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.polarsys.capella.core.data.ctx.SystemComponentPkg) return edge_explorer_24_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_24 = new EdgeExplorer(this, 4, 7, edge_explorer_24_methods);
		name2explorer.put("edge_explorer_24", edge_explorer_24);
		EdgeLookupMethods edge_explorer_25_methods = new EdgeLookupMethods();
						edge_explorer_25_methods.unique_lookup = (o) -> ((org.polarsys.capella.core.data.oa.OperationalAnalysis) o).getOwnedEntityPkg();
						edge_explorer_25_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.polarsys.capella.core.data.oa.OperationalAnalysis) return o.equals(edge_explorer_25_methods.unique_lookup.apply(result)) ? result : null; else return null;};
						edge_explorer_25 = new EdgeExplorer(this, 1, 0, edge_explorer_25_methods);
		name2explorer.put("edge_explorer_25", edge_explorer_25);
		EdgeLookupMethods edge_explorer_26_methods = new EdgeLookupMethods();
						edge_explorer_26_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) o).getCONTEXT__TRG__trg_componenet_pkg();
						edge_explorer_26 = new CachedEdgeExplorer(this, 11, 4, edge_explorer_26_methods);
	...
	protected void initializeOrchestration() {
		...
		edge_explorer_6_1_orchestration = initializeOrchestration(node.getOrchestrations().get(13).getPlan());
		edge_explorer_7_0_orchestration = initializeOrchestration(node.getOrchestrations().get(14).getPlan());
		edge_explorer_7_1_orchestration = initializeOrchestration(node.getOrchestrations().get(15).getPlan());
		edge_explorer_8_0_orchestration = initializeOrchestration(node.getOrchestrations().get(16).getPlan());
		edge_explorer_8_1_orchestration = initializeOrchestration(node.getOrchestrations().get(17).getPlan());
		edge_explorer_9_0_orchestration = initializeOrchestration(node.getOrchestrations().get(18).getPlan());
		edge_explorer_10_0_orchestration = initializeOrchestration(node.getOrchestrations().get(19).getPlan());
		edge_explorer_11_0_orchestration = initializeOrchestration(node.getOrchestrations().get(20).getPlan());
		edge_explorer_11_1_orchestration = initializeOrchestration(node.getOrchestrations().get(21).getPlan());
		edge_explorer_12_0_orchestration = initializeOrchestration(node.getOrchestrations().get(22).getPlan());
		edge_explorer_13_0_orchestration = initializeOrchestration(node.getOrchestrations().get(23).getPlan());
		...
		edge_explorer_17_0_orchestration = initializeOrchestration(node.getOrchestrations().get(27).getPlan());
		edge_explorer_18_0_orchestration = initializeOrchestration(node.getOrchestrations().get(28).getPlan());
		edge_explorer_19_0_orchestration = initializeOrchestration(node.getOrchestrations().get(29).getPlan());
		edge_explorer_20_0_orchestration = initializeOrchestration(node.getOrchestrations().get(30).getPlan());
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			case "EntityPkg_object_SP1": 
				{
					
					// src_entity_pkg
					HMatch match_0 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch", 12);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_11_1_orchestration, match_0);
				}
				break;
			case "OperationalAnalysis_object_SP1": 
				{
					if(!lazy_initialization) {
						
						// src_oa_arch
						HMatch match_1 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch", 12);
			...
			case "Entity_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// src_oa_entity
						HMatch match_2 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch", 12);
			...
			case "Part_object_SP1": 
				{
					...
					// src_oa_part
					HMatch match_3 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch", 12);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_1_orchestration, match_3);
					edge_explorer_3.registerSourceObject(objs[0]);
					
					// trg_sys_part
					HMatch match_7 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch", 12);
			...
			case "SystemComponentPkg_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// trg_componenet_pkg
						HMatch match_4 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch", 12);
			...
			case "SystemAnalysis_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// trg_sa_arch
						HMatch match_5 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch", 12);
						match_5.getNodes()[5] = objs[0];
						start(edge_explorer_4_1_orchestration, match_5);
					}
				}
				break;
			case "SystemComponent_object": 
				{
					if(!lazy_initialization) {
						
						// trg_sys_component
						HMatch match_6 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch", 12);
			...
			case "Entity2SystemComponent_object": 
				{
					...
					// entity2component
					HMatch match_8 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch", 12);
			...
			case "Oa2Sa_object": 
				{
					...
					// oa2sa
					HMatch match_9 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch", 12);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_6_1_orchestration, match_9);
				}
				break;
			case "OaPart2SaPart_object": 
				{
					...
					// part2part
					HMatch match_10 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch", 12);
					match_10.getNodes()[10] = objs[0];
					start(edge_explorer_7_1_orchestration, match_10);
				}
				break;
			case "Oa2Sa_transition_actors__Marker_object": 
				{
					...
					HMatch match_11 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch", 12);
					match_11.getNodes()[11] = objs[0];
					start(edge_explorer_5_1_orchestration, match_11);
				}
				break;
			case "Oa2Sa_transition_actors_src_oa_entity_ownedEntities_incoming_SRC__FILTER_NAC_SRC_21_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "Oa2Sa_transition_actors_src_oa_entity_ownedEntities_incoming_SRC__FILTER_NAC_SRC_21_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch", 12);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "modellingcore.AbstractTypedElement_abstractType_AbstractType": 
			if(!lazy_initialization) {
				...
				if(msg.target instanceof org.polarsys.capella.core.data.oa.Entity) {
				{
					...
					HMatch match = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_24_localSearch", 12);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
