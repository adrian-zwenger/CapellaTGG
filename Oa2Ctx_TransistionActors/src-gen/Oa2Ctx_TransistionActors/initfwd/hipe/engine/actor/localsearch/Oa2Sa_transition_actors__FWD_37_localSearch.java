...
public class Oa2Sa_transition_actors__FWD_37_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.multi_lookup = (o) -> ((org.polarsys.capella.core.data.oa.EntityPkg) o).getOwnedEntities();
						edge_explorer_3_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.polarsys.capella.core.data.oa.EntityPkg) return edge_explorer_3_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_3 = new EdgeExplorer(this, 1, 5, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa) o).getTarget();
						edge_explorer_4 = new CachedEdgeExplorer(this, 0, 4, edge_explorer_4_methods);
	...
	protected void initializeOrchestration() {
		...
		nac_checker_orchestration = initializeOrchestration(node.getOrchestrations().get(14).getPlan());
	}
	
	@Override
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		ports = new LinkedList<>();
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("Oa2Sa_transition_actors__FWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Oa2Sa_object": 
				{
					...
					// oa2sa
					HMatch match_0 = new LocalSearchMatch("Oa2Sa_transition_actors__FWD_37_localSearch", 7);
			...
			case "EntityPkg_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// src_entity_pkg
						HMatch match_1 = new LocalSearchMatch("Oa2Sa_transition_actors__FWD_37_localSearch", 7);
			...
			case "OperationalAnalysis_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// src_oa_arch
						HMatch match_2 = new LocalSearchMatch("Oa2Sa_transition_actors__FWD_37_localSearch", 7);
			...
			case "SystemComponentPkg_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// trg_componenet_pkg
						HMatch match_3 = new LocalSearchMatch("Oa2Sa_transition_actors__FWD_37_localSearch", 7);
			...
			case "SystemAnalysis_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// trg_sa_arch
						HMatch match_4 = new LocalSearchMatch("Oa2Sa_transition_actors__FWD_37_localSearch", 7);
			...
			case "Entity_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// src_oa_entity
						HMatch match_5 = new LocalSearchMatch("Oa2Sa_transition_actors__FWD_37_localSearch", 7);
			...
			case "Part_object_SP0": 
				{
					...
					// src_oa_part
					HMatch match_6 = new LocalSearchMatch("Oa2Sa_transition_actors__FWD_37_localSearch", 7);
		...
		switch(match.creator) {
			...
			case "Oa2Sa_transition_actors_src_oa_entity_ownedEntities_incoming_SRC__FILTER_NAC_SRC_21_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("Oa2Sa_transition_actors__FWD_37_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.polarsys.capella.core.data.ctx.SystemAnalysis_ownedSystemComponentPkg_SystemComponentPkg": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("Oa2Sa_transition_actors__FWD_37_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
