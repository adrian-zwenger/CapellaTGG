...
public class Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Entity2SystemComponent) o).getSource();
						edge_explorer = new CachedEdgeExplorer(this, 7, 0, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.multi_lookup = (o) -> ((org.polarsys.capella.core.data.oa.Entity) o).getOwnedEntities();
						edge_explorer_3_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.polarsys.capella.core.data.oa.Entity) return edge_explorer_3_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_3 = new EdgeExplorer(this, 2, 0, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Entity2SystemComponent) o).getTarget();
						edge_explorer_4 = new CachedEdgeExplorer(this, 7, 4, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) o).getCREATE__SRC__src_operational_entity();
						edge_explorer_5 = new CachedEdgeExplorer(this, 9, 0, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) o).getCONTEXT__TRG__trg_sa_arch();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) o).getCONTEXT__TRG__trg_system_component_pkg();
						edge_explorer_7 = new CachedEdgeExplorer(this, 9, 5, edge_explorer_7_methods);
		name2explorer.put("edge_explorer_7", edge_explorer_7);
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) o).getCREATE__CORR__OaEntity2SaSysComponent();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.multi_lookup = (o) -> ((org.polarsys.capella.core.data.ctx.SystemComponentPkg) o).getOwnedSystemComponents();
						edge_explorer_10_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.polarsys.capella.core.data.ctx.SystemComponentPkg) return edge_explorer_10_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_10 = new EdgeExplorer(this, 5, 4, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) o).getCREATE__CORR__part2part();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) o).getCREATE__SRC__src_operational_part();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.multi_lookup = (o) -> ((org.polarsys.capella.core.data.capellacore.Classifier) o).getOwnedFeatures().stream().filter(obj -> obj instanceof org.polarsys.capella.core.data.cs.Part).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						...
						edge_explorer_14 = new EdgeExplorer(this, 3, 5, edge_explorer_14_methods);
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) o).getCREATE__TRG__trg_system_part();
						edge_explorer_16 = new CachedEdgeExplorer(this, 9, 6, edge_explorer_16_methods);
		name2explorer.put("edge_explorer_16", edge_explorer_16);
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) o).getCREATE__TRG__trg_system_component();
		...
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> {EObject result = ((modellingcore.AbstractTypedElement) o).getAbstractType(); return (result instanceof org.polarsys.capella.core.data.ctx.SystemComponent ? result : null);};
		...
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						...
						edge_explorer_19_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.polarsys.capella.core.data.ctx.SystemComponentPkg) return edge_explorer_19_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_19 = new EdgeExplorer(this, 5, 6, edge_explorer_19_methods);
		...
		EdgeLookupMethods edge_explorer_21_methods = new EdgeLookupMethods();
						edge_explorer_21_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.OaPart2SaPart) o).getTarget();
						edge_explorer_21 = new CachedEdgeExplorer(this, 8, 6, edge_explorer_21_methods);
			...
			case "Entity_object_SP0": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch", 10);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_2_orchestration, match_0);
					
					// src_top_level_entity
					HMatch match_2 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch", 10);
			...
			case "Part_object_SP1": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch", 10);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_9_1_orchestration, match_1);
					edge_explorer_18.registerSourceObject(objs[0]);
					
					// trg_system_part
					HMatch match_6 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch", 10);
			...
			case "SystemAnalysis_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// trg_sa_arch
						HMatch match_3 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch", 10);
			...
			case "SystemComponent_object": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_4 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch", 10);
			...
			case "SystemComponentPkg_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_5 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch", 10);
			...
			case "Entity2SystemComponent_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch", 10);
			...
			case "OaPart2SaPart_object": 
				{
					...
					// part2part
					HMatch match_8 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch", 10);
			...
			case "Oa2Sa_transition_actors_recursively__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_5_1_orchestration, match_9);
				}
				break;
			case "Oa2Sa_transition_actors_recursively_src_operational_entity_ownedEntities_incoming_SRC__FILTER_NAC_SRC_45_localSearch": 
				{
				...
				break;
			case "Oa2Sa_transition_actors_recursively_src_operational_part_ownedParts_incoming_SRC__FILTER_NAC_SRC_48_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "Oa2Sa_transition_actors_recursively_src_operational_entity_ownedEntities_incoming_SRC__FILTER_NAC_SRC_45_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "Oa2Sa_transition_actors_recursively_src_operational_part_ownedParts_incoming_SRC__FILTER_NAC_SRC_48_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch", 10);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_51_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_8.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_operational_entity.getName(), "java.lang.String"));
		csp_8.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_operational_part.getName(), "java.lang.String"));
		csp_8.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_9.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trg_system_component.getName(), "java.lang.String"));
		csp_9.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trg_system_part.getName(), "java.lang.String"));
		csp_9.solve();
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		csp_10.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_operational_entity.getName(), "java.lang.String"));
