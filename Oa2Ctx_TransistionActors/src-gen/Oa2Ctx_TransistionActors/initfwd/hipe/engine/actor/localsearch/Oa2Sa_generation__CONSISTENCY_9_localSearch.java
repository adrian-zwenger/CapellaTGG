...
public class Oa2Sa_generation__CONSISTENCY_9_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker) o).getCREATE__SRC__src_oa_arch();
						edge_explorer = new CachedEdgeExplorer(this, 7, 1, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker) o).getCREATE__TRG__trg_system_as_component();
						edge_explorer_3 = new CachedEdgeExplorer(this, 7, 3, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker) o).getCREATE__TRG__trg_system_component_pkg();
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.multi_lookup = (o) -> ((org.polarsys.capella.core.data.cs.ComponentPkg) o).getOwnedParts();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa) o).getSource();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.multi_lookup = (o) -> ((org.polarsys.capella.core.data.ctx.SystemComponentPkg) o).getOwnedSystemComponents();
						...
						edge_explorer_8 = new EdgeExplorer(this, 5, 3, edge_explorer_8_methods);
		name2explorer.put("edge_explorer_8", edge_explorer_8);
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker) o).getCREATE__TRG__trg_sa_arch();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((modellingcore.AbstractTypedElement) o).getAbstractType(); return (result instanceof org.polarsys.capella.core.data.ctx.SystemComponent ? result : null);};
						edge_explorer_11 = new CachedEdgeExplorer(this, 4, 3, edge_explorer_11_methods);
		name2explorer.put("edge_explorer_11", edge_explorer_11);
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((org.polarsys.capella.core.data.ctx.SystemAnalysis) o).getOwnedSystemComponentPkg();
						edge_explorer_12_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.polarsys.capella.core.data.ctx.SystemAnalysis) return o.equals(edge_explorer_12_methods.unique_lookup.apply(result)) ? result : null; else return null;};
						edge_explorer_12 = new EdgeExplorer(this, 2, 5, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker) o).getCREATE__TRG__trg_system_as_part();
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker) o).getCREATE__CORR__new_oa2sa();
						edge_explorer_14 = new CachedEdgeExplorer(this, 7, 6, edge_explorer_14_methods);
		name2explorer.put("edge_explorer_14", edge_explorer_14);
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_generation__Marker) o).getCREATE__SRC__src_entity_pkg();
						edge_explorer_15 = new CachedEdgeExplorer(this, 7, 0, edge_explorer_15_methods);
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			case "EntityPkg_object_SP0": 
				{
					...
					// src_entity_pkg
					HMatch match_0 = new LocalSearchMatch("Oa2Sa_generation__CONSISTENCY_9_localSearch", 8);
			...
			case "OperationalAnalysis_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// src_oa_arch
						HMatch match_1 = new LocalSearchMatch("Oa2Sa_generation__CONSISTENCY_9_localSearch", 8);
			...
			case "SystemAnalysis_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// trg_sa_arch
						HMatch match_2 = new LocalSearchMatch("Oa2Sa_generation__CONSISTENCY_9_localSearch", 8);
			...
			case "SystemComponent_object": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_3 = new LocalSearchMatch("Oa2Sa_generation__CONSISTENCY_9_localSearch", 8);
			...
			case "Part_object_SP0": 
				{
					...
					// trg_system_as_part
					HMatch match_4 = new LocalSearchMatch("Oa2Sa_generation__CONSISTENCY_9_localSearch", 8);
			...
			case "SystemComponentPkg_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_5 = new LocalSearchMatch("Oa2Sa_generation__CONSISTENCY_9_localSearch", 8);
			...
			case "Oa2Sa_object": 
				{
					...
					// new_oa2sa
					HMatch match_6 = new LocalSearchMatch("Oa2Sa_generation__CONSISTENCY_9_localSearch", 8);
			...
			case "Oa2Sa_generation__Marker_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("Oa2Sa_generation__CONSISTENCY_9_localSearch", 8);
			...
			case "Oa2Sa_generation_src_oa_arch_ownedEntityPkg_outgoing_SRC__FILTER_NAC_SRC_1_localSearch": 
				...
				break;
			case "Oa2Sa_generation_trg_sa_arch_ownedSystemComponentPkg_outgoing_TRG__FILTER_NAC_TRG_5_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "Oa2Sa_generation_src_oa_arch_ownedEntityPkg_outgoing_SRC__FILTER_NAC_SRC_1_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("Oa2Sa_generation__CONSISTENCY_9_localSearch", 8);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "Oa2Sa_generation_trg_sa_arch_ownedSystemComponentPkg_outgoing_TRG__FILTER_NAC_TRG_5_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("Oa2Sa_generation__CONSISTENCY_9_localSearch", 8);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("Oa2Sa_generation__CONSISTENCY_9_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
