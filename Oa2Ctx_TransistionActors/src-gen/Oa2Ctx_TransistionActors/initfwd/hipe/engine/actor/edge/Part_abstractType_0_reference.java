package Oa2Ctx_TransistionActors.initfwd.hipe.engine.actor.edge;
...
public class Part_abstractType_0_reference extends GenericReferenceActor<modellingcore.AbstractTypedElement,modellingcore.AbstractType> {

	@Override
	protected void initializePorts(Map<String, ActorRef> name2actor, ReferenceNode node) {
		ports = new LinkedList<>();
		ports.add(new PortEdgeLeft(node.getPorts().getPort().get(0), getSelf(), name2actor.get("Oa2Sa_transition_actors_recursively__FWD_71_nacjunction"), this::check_constraint_10 , 0   ));
	}	
	...
	public boolean check_constraint_10(EdgeMatch edge, int index) {
		...
		csp_11.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_operational_part.getName(), "java.lang.String"));
		csp_11.solve();
