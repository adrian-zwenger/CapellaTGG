...
public class Oa2Sa_transition_actors__BWD_23_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((org.polarsys.capella.core.data.oa.OperationalAnalysis) o).getOwnedEntityPkg();
						edge_explorer_3_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.polarsys.capella.core.data.oa.OperationalAnalysis) return o.equals(edge_explorer_3_methods.unique_lookup.apply(result)) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						...
						edge_explorer_7 = new CachedEdgeExplorer(this, 0, 4, edge_explorer_7_methods);
		name2explorer.put("edge_explorer_7", edge_explorer_7);
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((modellingcore.AbstractTypedElement) o).getAbstractType(); return (result instanceof org.polarsys.capella.core.data.ctx.SystemComponent ? result : null);};
			...
			case "Oa2Sa_object": 
				{
					...
					// oa2sa
					HMatch match_0 = new LocalSearchMatch("Oa2Sa_transition_actors__BWD_23_localSearch", 7);
			...
			case "EntityPkg_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// src_entity_pkg
						HMatch match_1 = new LocalSearchMatch("Oa2Sa_transition_actors__BWD_23_localSearch", 7);
			...
			case "OperationalAnalysis_object": 
				{
					if(!lazy_initialization) {
						...
						// src_oa_arch
						HMatch match_2 = new LocalSearchMatch("Oa2Sa_transition_actors__BWD_23_localSearch", 7);
			...
			case "SystemComponentPkg_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// trg_componenet_pkg
						HMatch match_3 = new LocalSearchMatch("Oa2Sa_transition_actors__BWD_23_localSearch", 7);
			...
			case "SystemAnalysis_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// trg_sa_arch
						HMatch match_4 = new LocalSearchMatch("Oa2Sa_transition_actors__BWD_23_localSearch", 7);
			...
			case "SystemComponent_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// trg_sys_component
						HMatch match_5 = new LocalSearchMatch("Oa2Sa_transition_actors__BWD_23_localSearch", 7);
			...
			case "Part_object_SP0": 
				{
					...
					// trg_sys_part
					HMatch match_6 = new LocalSearchMatch("Oa2Sa_transition_actors__BWD_23_localSearch", 7);
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("Oa2Sa_transition_actors__BWD_23_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
