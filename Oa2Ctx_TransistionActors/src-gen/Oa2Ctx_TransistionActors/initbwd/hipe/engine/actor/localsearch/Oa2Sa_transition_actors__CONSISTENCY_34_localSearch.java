...
public class Oa2Sa_transition_actors__CONSISTENCY_34_localSearch extends GenericLocalSearchActor{
	...
	SearchOrchestration edge_explorer_21_1_orchestration;
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) o).getCONTEXT__SRC__src_entity_pkg();
						edge_explorer_3 = new CachedEdgeExplorer(this, 11, 0, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) o).getCONTEXT__SRC__src_oa_arch();
						edge_explorer_4 = new CachedEdgeExplorer(this, 11, 1, edge_explorer_4_methods);
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.multi_lookup = (o) -> ((org.polarsys.capella.core.data.oa.EntityPkg) o).getOwnedEntities();
						edge_explorer_6_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.polarsys.capella.core.data.oa.EntityPkg) return edge_explorer_6_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) o).getCREATE__CORR__part2part();
						edge_explorer_7 = new CachedEdgeExplorer(this, 11, 10, edge_explorer_7_methods);
		name2explorer.put("edge_explorer_7", edge_explorer_7);
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((org.polarsys.capella.core.data.oa.OperationalAnalysis) o).getOwnedEntityPkg();
						edge_explorer_8_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.polarsys.capella.core.data.oa.OperationalAnalysis) return o.equals(edge_explorer_8_methods.unique_lookup.apply(result)) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9 = new CachedEdgeExplorer(this, 3, 2, edge_explorer_9_methods);
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) o).getCREATE__SRC__src_oa_entity();
						edge_explorer_11 = new CachedEdgeExplorer(this, 11, 2, edge_explorer_11_methods);
		name2explorer.put("edge_explorer_11", edge_explorer_11);
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) o).getCONTEXT__CORR__oa2sa();
						edge_explorer_12 = new CachedEdgeExplorer(this, 11, 9, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) o).getCREATE__TRG__trg_sys_component();
						edge_explorer_13 = new CachedEdgeExplorer(this, 11, 6, edge_explorer_13_methods);
		name2explorer.put("edge_explorer_13", edge_explorer_13);
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((org.polarsys.capella.core.data.ctx.SystemAnalysis) o).getOwnedSystemComponentPkg();
						edge_explorer_14_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.polarsys.capella.core.data.ctx.SystemAnalysis) return o.equals(edge_explorer_14_methods.unique_lookup.apply(result)) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa) o).getSource();
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.OaPart2SaPart) o).getTarget();
						edge_explorer_16 = new CachedEdgeExplorer(this, 10, 7, edge_explorer_16_methods);
		name2explorer.put("edge_explorer_16", edge_explorer_16);
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.multi_lookup = (o) -> ((org.polarsys.capella.core.data.cs.ComponentPkg) o).getOwnedParts();
						edge_explorer_17_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.polarsys.capella.core.data.ctx.SystemComponentPkg) return edge_explorer_17_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_17 = new EdgeExplorer(this, 4, 7, edge_explorer_17_methods);
		name2explorer.put("edge_explorer_17", edge_explorer_17);
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.multi_lookup = (o) -> ((org.polarsys.capella.core.data.cs.ComponentPkg) o).getOwnedParts();
						edge_explorer_18_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.polarsys.capella.core.data.oa.EntityPkg) return edge_explorer_18_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_18 = new EdgeExplorer(this, 0, 3, edge_explorer_18_methods);
		name2explorer.put("edge_explorer_18", edge_explorer_18);
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) o).getCREATE__SRC__src_oa_part();
						edge_explorer_19 = new CachedEdgeExplorer(this, 11, 3, edge_explorer_19_methods);
		name2explorer.put("edge_explorer_19", edge_explorer_19);
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.OaPart2SaPart) o).getSource();
						edge_explorer_20 = new CachedEdgeExplorer(this, 10, 3, edge_explorer_20_methods);
		name2explorer.put("edge_explorer_20", edge_explorer_20);
		EdgeLookupMethods edge_explorer_21_methods = new EdgeLookupMethods();
						edge_explorer_21_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) o).getCREATE__CORR__entity2component();
						edge_explorer_21 = new CachedEdgeExplorer(this, 11, 8, edge_explorer_21_methods);
		name2explorer.put("edge_explorer_21", edge_explorer_21);
		EdgeLookupMethods edge_explorer_22_methods = new EdgeLookupMethods();
						edge_explorer_22_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa) o).getTarget();
						edge_explorer_22 = new CachedEdgeExplorer(this, 9, 5, edge_explorer_22_methods);
		name2explorer.put("edge_explorer_22", edge_explorer_22);
		EdgeLookupMethods edge_explorer_23_methods = new EdgeLookupMethods();
						edge_explorer_23_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) o).getCONTEXT__TRG__trg_componenet_pkg();
						edge_explorer_23 = new CachedEdgeExplorer(this, 11, 4, edge_explorer_23_methods);
		name2explorer.put("edge_explorer_23", edge_explorer_23);
		EdgeLookupMethods edge_explorer_24_methods = new EdgeLookupMethods();
						edge_explorer_24_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Entity2SystemComponent) o).getTarget();
						edge_explorer_24 = new CachedEdgeExplorer(this, 8, 6, edge_explorer_24_methods);
		name2explorer.put("edge_explorer_24", edge_explorer_24);
		EdgeLookupMethods edge_explorer_25_methods = new EdgeLookupMethods();
						edge_explorer_25_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Entity2SystemComponent) o).getSource();
						edge_explorer_25 = new CachedEdgeExplorer(this, 8, 2, edge_explorer_25_methods);
		name2explorer.put("edge_explorer_25", edge_explorer_25);
		EdgeLookupMethods edge_explorer_26_methods = new EdgeLookupMethods();
						edge_explorer_26_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors__Marker) o).getCONTEXT__TRG__trg_sa_arch();
						edge_explorer_26 = new CachedEdgeExplorer(this, 11, 5, edge_explorer_26_methods);
	...
	protected void initializeOrchestration() {
		...
		edge_explorer_21_1_orchestration = initializeOrchestration(node.getOrchestrations().get(31).getPlan());
			...
			case "EntityPkg_object_SP1": 
				{
					...
					// src_entity_pkg
					HMatch match_0 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_34_localSearch", 12);
			...
			case "OperationalAnalysis_object": 
				{
					if(!lazy_initialization) {
						...
						// src_oa_arch
						HMatch match_1 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_34_localSearch", 12);
			...
			case "Entity_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// src_oa_entity
						HMatch match_2 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_34_localSearch", 12);
			...
			case "Part_object_SP1": 
				{
					...
					// src_oa_part
					HMatch match_3 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_34_localSearch", 12);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_9_1_orchestration, match_3);
					edge_explorer_5.registerSourceObject(objs[0]);
					
					// trg_sys_part
					HMatch match_7 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_34_localSearch", 12);
			...
			case "SystemComponentPkg_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// trg_componenet_pkg
						HMatch match_4 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_34_localSearch", 12);
			...
			case "SystemAnalysis_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// trg_sa_arch
						HMatch match_5 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_34_localSearch", 12);
			...
			case "SystemComponent_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// trg_sys_component
						HMatch match_6 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_34_localSearch", 12);
			...
			case "Entity2SystemComponent_object": 
				{
					...
					// entity2component
					HMatch match_8 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_34_localSearch", 12);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_21_1_orchestration, match_8);
				}
				break;
			case "Oa2Sa_object": 
				{
					...
					// oa2sa
					HMatch match_9 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_34_localSearch", 12);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_12_1_orchestration, match_9);
				}
				break;
			case "OaPart2SaPart_object": 
				{
					...
					// part2part
					HMatch match_10 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_34_localSearch", 12);
			...
			case "Oa2Sa_transition_actors__Marker_object": 
				{
					...
					HMatch match_11 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_34_localSearch", 12);
					match_11.getNodes()[11] = objs[0];
					start(edge_explorer_3_1_orchestration, match_11);
				}
				break;
			case "Oa2Sa_transition_actors_src_oa_entity_ownedEntities_incoming_SRC__FILTER_NAC_SRC_31_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "Oa2Sa_transition_actors_src_oa_entity_ownedEntities_incoming_SRC__FILTER_NAC_SRC_31_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_34_localSearch", 12);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.polarsys.capella.core.data.ctx.SystemComponentPkg_ownedSystemComponents_SystemComponent": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("Oa2Sa_transition_actors__CONSISTENCY_34_localSearch", 12);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[6] = msg.target;
					currentDepth++;
