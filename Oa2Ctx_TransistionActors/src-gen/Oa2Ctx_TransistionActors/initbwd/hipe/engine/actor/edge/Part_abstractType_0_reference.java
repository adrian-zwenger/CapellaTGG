package Oa2Ctx_TransistionActors.initbwd.hipe.engine.actor.edge;
...
public class Part_abstractType_0_reference extends GenericReferenceActor<modellingcore.AbstractTypedElement,modellingcore.AbstractType> {
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, ReferenceNode node) {
		...
		ports.add(new PortEdgeRight(node.getPorts().getPort().get(0), getSelf(), name2actor.get("Oa2Sa_transition_actors_recursively__BWD_51_junction"), this::check_constraint_13 , 0   ));
	}	
	...
	public boolean check_constraint_13(EdgeMatch edge, int index) {
		...
		csp_8.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trg_system_component.getName(), "java.lang.String"));
		csp_8.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trg_system_part.getName(), "java.lang.String"));
		csp_8.solve();
