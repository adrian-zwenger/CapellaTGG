...
public class Oa2Sa_transition_actors_recursively__SRC_109_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.multi_lookup = (o) -> ((org.polarsys.capella.core.data.capellacore.Classifier) o).getOwnedFeatures().stream().filter(obj -> obj instanceof org.polarsys.capella.core.data.cs.Part).collect(Collectors.toList());
						edge_explorer_4_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.polarsys.capella.core.data.oa.Entity) return edge_explorer_4_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
	...
	protected void initializeOrchestration() {
		...
		nac_checker_orchestration = initializeOrchestration(node.getOrchestrations().get(6).getPlan());
		nac_checker_0_orchestration = initializeOrchestration(node.getOrchestrations().get(7).getPlan());
	}
	
	@Override
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		ports = new LinkedList<>();
		ports.add(new PortJunctionRight(node.getPorts().getPort().get(0), getSelf(), name2actor.get("Oa2Sa_transition_actors_recursively__FWD_113_junction"), this::returnTrue , 0  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("Oa2Sa_transition_actors_recursively__SRC_production"), this::returnTrue , 1  , false ));
	}
			...
			case "Entity_object_SP0": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__SRC_109_localSearch", 3);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_2_orchestration, match_0);
					
					// src_top_level_entity
					HMatch match_2 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__SRC_109_localSearch", 3);
			...
			case "Part_object_SP0": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__SRC_109_localSearch", 3);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_1_orchestration, match_1);
				}
				break;
			case "Oa2Sa_transition_actors_recursively_src_operational_entity_ownedEntities_incoming_SRC__FILTER_NAC_SRC_81_localSearch": 
				{
				...
				break;
			case "Oa2Sa_transition_actors_recursively_src_operational_part_ownedParts_incoming_SRC__FILTER_NAC_SRC_84_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "Oa2Sa_transition_actors_recursively_src_operational_entity_ownedEntities_incoming_SRC__FILTER_NAC_SRC_81_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__SRC_109_localSearch", 3);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "Oa2Sa_transition_actors_recursively_src_operational_part_ownedParts_incoming_SRC__FILTER_NAC_SRC_84_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__SRC_109_localSearch", 3);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
		...
		case "modellingcore.AbstractTypedElement_abstractType_AbstractType": 
			if(!lazy_initialization) {
				...
				if(msg.target instanceof org.polarsys.capella.core.data.oa.Entity) {
				{
					...
					HMatch match = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__SRC_109_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_26.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_operational_entity.getName(), "java.lang.String"));
		csp_26.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_operational_part.getName(), "java.lang.String"));
		csp_26.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_25.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_operational_entity.getName(), "java.lang.String"));
		csp_25.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_operational_part.getName(), "java.lang.String"));
		csp_25.solve();
