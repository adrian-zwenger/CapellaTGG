...
public class Oa2Sa_generation__TRG_5_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new EdgeExplorer(this, 3, 1, edge_explorer_5_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("Oa2Sa_generation__BWD_10_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("Oa2Sa_generation__TRG_production"), this::returnTrue , 0  , false ));
	}
			...
			case "SystemAnalysis_object_SP0": 
				{
					...
					// trg_sa_arch
					HMatch match_0 = new LocalSearchMatch("Oa2Sa_generation__TRG_5_localSearch", 4);
			...
			case "SystemComponent_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("Oa2Sa_generation__TRG_5_localSearch", 4);
			...
			case "Part_object_SP0": 
				{
					...
					// trg_system_as_part
					HMatch match_2 = new LocalSearchMatch("Oa2Sa_generation__TRG_5_localSearch", 4);
			...
			case "SystemComponentPkg_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_3 = new LocalSearchMatch("Oa2Sa_generation__TRG_5_localSearch", 4);
		...
		switch(match.creator) {
			...
			case "Oa2Sa_generation_trg_sa_arch_ownedSystemComponentPkg_outgoing_TRG__FILTER_NAC_TRG_1_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("Oa2Sa_generation__TRG_5_localSearch", 4);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.polarsys.capella.core.data.cs.ComponentPkg_ownedParts_Part": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("Oa2Sa_generation__TRG_5_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
