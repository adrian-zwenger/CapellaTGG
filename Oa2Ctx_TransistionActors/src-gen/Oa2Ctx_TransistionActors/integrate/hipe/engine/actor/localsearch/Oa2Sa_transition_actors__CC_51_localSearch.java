...
public class Oa2Sa_transition_actors__CC_51_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((modellingcore.AbstractTypedElement) o).getAbstractType(); return (result instanceof org.polarsys.capella.core.data.oa.Entity ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 5, edge_explorer_5_methods);
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new EdgeExplorer(this, 3, 7, edge_explorer_6_methods);
		name2explorer.put("edge_explorer_6", edge_explorer_6);
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.multi_lookup = (o) -> ((org.polarsys.capella.core.data.oa.EntityPkg) o).getOwnedEntities();
						edge_explorer_7_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.polarsys.capella.core.data.oa.EntityPkg) return edge_explorer_7_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_7 = new EdgeExplorer(this, 1, 5, edge_explorer_7_methods);
		name2explorer.put("edge_explorer_7", edge_explorer_7);
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa) o).getSource();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.multi_lookup = (o) -> ((org.polarsys.capella.core.data.cs.ComponentPkg) o).getOwnedParts();
						...
						edge_explorer_9 = new EdgeExplorer(this, 3, 8, edge_explorer_9_methods);
		name2explorer.put("edge_explorer_9", edge_explorer_9);
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa) o).getTarget();
						edge_explorer_10 = new CachedEdgeExplorer(this, 0, 4, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((org.polarsys.capella.core.data.oa.OperationalAnalysis) o).getOwnedEntityPkg();
						edge_explorer_11_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.polarsys.capella.core.data.oa.OperationalAnalysis) return o.equals(edge_explorer_11_methods.unique_lookup.apply(result)) ? result : null; else return null;};
						edge_explorer_11 = new EdgeExplorer(this, 2, 1, edge_explorer_11_methods);
			...
			case "Oa2Sa_object": 
				{
					...
					// oa2sa
					HMatch match_0 = new LocalSearchMatch("Oa2Sa_transition_actors__CC_51_localSearch", 9);
			...
			case "EntityPkg_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// src_entity_pkg
						HMatch match_1 = new LocalSearchMatch("Oa2Sa_transition_actors__CC_51_localSearch", 9);
			...
			case "OperationalAnalysis_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// src_oa_arch
						HMatch match_2 = new LocalSearchMatch("Oa2Sa_transition_actors__CC_51_localSearch", 9);
			...
			case "SystemComponentPkg_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// trg_componenet_pkg
						HMatch match_3 = new LocalSearchMatch("Oa2Sa_transition_actors__CC_51_localSearch", 9);
			...
			case "SystemAnalysis_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// trg_sa_arch
						HMatch match_4 = new LocalSearchMatch("Oa2Sa_transition_actors__CC_51_localSearch", 9);
			...
			case "Entity_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// src_oa_entity
						HMatch match_5 = new LocalSearchMatch("Oa2Sa_transition_actors__CC_51_localSearch", 9);
			...
			case "Part_object_SP0": 
				{
					...
					// src_oa_part
					HMatch match_6 = new LocalSearchMatch("Oa2Sa_transition_actors__CC_51_localSearch", 9);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_2_orchestration, match_6);
					edge_explorer_3.registerSourceObject(objs[0]);
					
					// trg_sys_part
					HMatch match_8 = new LocalSearchMatch("Oa2Sa_transition_actors__CC_51_localSearch", 9);
			...
			case "SystemComponent_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// trg_sys_component
						HMatch match_7 = new LocalSearchMatch("Oa2Sa_transition_actors__CC_51_localSearch", 9);
						match_7.getNodes()[7] = objs[0];
						start(edge_explorer_3_2_orchestration, match_7);
					}
				}
				break;
			case "Oa2Sa_transition_actors_src_oa_entity_ownedEntities_incoming_SRC__FILTER_NAC_SRC_48_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "Oa2Sa_transition_actors_src_oa_entity_ownedEntities_incoming_SRC__FILTER_NAC_SRC_48_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("Oa2Sa_transition_actors__CC_51_localSearch", 9);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.polarsys.capella.core.data.cs.ComponentPkg_ownedParts_Part": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("Oa2Sa_transition_actors__CC_51_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[6] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_5.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_entity_pkg.getName(), "java.lang.String"));
		csp_5.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "Operational Entities", "java.lang.String"));
		csp_5.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_6.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_oa_entity.getName(), "java.lang.String"));
		csp_6.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_oa_part.getName(), "java.lang.String"));
		csp_6.solve();
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		csp_7.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trg_componenet_pkg.getName(), "java.lang.String"));
		csp_7.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "Structure", "java.lang.String"));
		csp_7.solve();
	...
	public boolean constraint_checker_2_method(HMatch match) {
		...
		csp_8.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trg_sys_component.getName(), "java.lang.String"));
		csp_8.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trg_sys_part.getName(), "java.lang.String"));
		csp_8.solve();
	...
	public boolean constraint_checker_3_method(HMatch match) {
		...
		csp_9.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_oa_entity.getName(), "java.lang.String"));
		csp_9.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trg_sys_component.getName(), "java.lang.String"));
		csp_9.solve();
