...
public class Oa2Sa_transition_actors_recursively__CONSISTENCY_117_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) o).getCONTEXT__TRG__trg_sa_arch();
						edge_explorer = new CachedEdgeExplorer(this, 9, 3, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) o).getCREATE__CORR__OaEntity2SaSysComponent();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) o).getCREATE__SRC__src_operational_part();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.OaPart2SaPart) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) o).getCONTEXT__TRG__trg_system_component_pkg();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) o).getCREATE__SRC__src_operational_entity();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) o).getCONTEXT__SRC__src_top_level_entity();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) o).getCREATE__CORR__part2part();
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((Oa2Ctx_TransistionActors.Oa2Sa_transition_actors_recursively__Marker) o).getCREATE__TRG__trg_system_component();
		...
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {0,1,2,3,5}), node.getAllOverlaps().get(0));
		name2explorer.put("pac_explorer", pac_explorer);
		pac_explorer_0 = new PACExplorer(this, Arrays.asList(new Integer[] {2,3,4,5,6}), node.getAllOverlaps().get(1));
			...
			case "Entity2SystemComponent_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_117_localSearch", 10);
			...
			case "OaPart2SaPart_object": 
				{
					...
					// part2part
					HMatch match_8 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_117_localSearch", 10);
			...
			case "Oa2Sa_transition_actors_recursively__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_117_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_1_orchestration, match_9);
				}
				break;
			case "Oa2Sa_transition_actors_recursively__FWD_113_junction": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_117_localSearch", 10);
				...
				break;
			case "Oa2Sa_transition_actors_recursively__BWD_79_junction": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_117_localSearch", 10);
						acMatch_1.getNodes()[2] = objs[0];
						acMatch_1.getNodes()[3] = objs[1];
						acMatch_1.getNodes()[4] = objs[2];
						acMatch_1.getNodes()[5] = objs[3];
						acMatch_1.getNodes()[6] = objs[4];
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_117_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[9] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register Oa2Sa_transition_actors_recursively__FWD
		...
		// register Oa2Sa_transition_actors_recursively__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister Oa2Sa_transition_actors_recursively__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(5);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister Oa2Sa_transition_actors_recursively__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(5);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[2];
		oMatch_Nodes_1[1] = objs[3];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.polarsys.capella.core.data.ctx.SystemAnalysis) {
			HMatch match_3 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_117_localSearch", 10);
		...
		if(obj instanceof org.polarsys.capella.core.data.cs.Part) {
			HMatch match_1 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_117_localSearch", 10);
			...
			HMatch match_6 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_117_localSearch", 10);
		...
		if(obj instanceof org.polarsys.capella.core.data.ctx.SystemComponentPkg) {
			HMatch match_5 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_117_localSearch", 10);
		...
		if(obj instanceof org.polarsys.capella.core.data.ctx.SystemComponent) {
			HMatch match_4 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_117_localSearch", 10);
		...
		if(obj instanceof org.polarsys.capella.core.data.oa.Entity) {
			HMatch match_0 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_117_localSearch", 10);
			...
			HMatch match_2 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__CONSISTENCY_117_localSearch", 10);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_27.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_operational_entity.getName(), "java.lang.String"));
		csp_27.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_operational_part.getName(), "java.lang.String"));
		csp_27.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_28.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trg_system_component.getName(), "java.lang.String"));
		csp_28.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trg_system_part.getName(), "java.lang.String"));
		csp_28.solve();
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		csp_29.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_operational_entity.getName(), "java.lang.String"));
		csp_29.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trg_system_component.getName(), "java.lang.String"));
		csp_29.solve();
