...
public class Oa2Sa_transition_actors__BWD_44_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {3,4,5,6}), node.getAllOverlaps().get(0));
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("Oa2Sa_transition_actors__CONSISTENCY_70_localSearch"), this::returnTrue  , false ));
	}
			...
			case "Oa2Sa_object": 
				{
					...
					// oa2sa
					HMatch match_0 = new LocalSearchMatch("Oa2Sa_transition_actors__BWD_44_localSearch", 7);
			...
			case "EntityPkg_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// src_entity_pkg
						HMatch match_1 = new LocalSearchMatch("Oa2Sa_transition_actors__BWD_44_localSearch", 7);
			...
			case "OperationalAnalysis_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// src_oa_arch
						HMatch match_2 = new LocalSearchMatch("Oa2Sa_transition_actors__BWD_44_localSearch", 7);
						match_2.getNodes()[2] = objs[0];
						start(edge_explorer_3_1_orchestration, match_2);
					}
				}
				break;
			case "Oa2Sa_transition_actors__TRG_39_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("Oa2Sa_transition_actors__BWD_44_localSearch", 7);
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("Oa2Sa_transition_actors__BWD_44_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register Oa2Sa_transition_actors__TRG
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister Oa2Sa_transition_actors__TRG
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[3];
		oMatch_Nodes_0[1] = objs[4];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.polarsys.capella.core.data.cs.Part) {
			HMatch match_6 = new LocalSearchMatch("Oa2Sa_transition_actors__BWD_44_localSearch", 7);
		...
		if(obj instanceof org.polarsys.capella.core.data.ctx.SystemComponentPkg) {
			HMatch match_3 = new LocalSearchMatch("Oa2Sa_transition_actors__BWD_44_localSearch", 7);
		...
		if(obj instanceof org.polarsys.capella.core.data.ctx.SystemComponent) {
			HMatch match_5 = new LocalSearchMatch("Oa2Sa_transition_actors__BWD_44_localSearch", 7);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_2.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_entity_pkg.getName(), "java.lang.String"));
		csp_2.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "Operational Entities", "java.lang.String"));
		csp_2.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_3.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trg_componenet_pkg.getName(), "java.lang.String"));
		csp_3.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "Structure", "java.lang.String"));
		csp_3.solve();
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		csp_4.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trg_sys_part.getName(), "java.lang.String"));
		csp_4.solve();
