...
public class Oa2Sa_transition_actors_recursively__TRG_74_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunctionRight(node.getPorts().getPort().get(0), getSelf(), name2actor.get("Oa2Sa_transition_actors_recursively__BWD_79_junction"), this::returnTrue , 0  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("Oa2Sa_transition_actors_recursively__TRG_production"), this::returnTrue , 1  , false ));
	}
			...
			case "SystemAnalysis_object_SP0": 
				{
					...
					// trg_sa_arch
					HMatch match_0 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__TRG_74_localSearch", 4);
			...
			case "SystemComponent_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__TRG_74_localSearch", 4);
			...
			case "SystemComponentPkg_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_2 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__TRG_74_localSearch", 4);
			...
			case "Part_object_SP2": 
				{
					...
					// trg_system_part
					HMatch match_3 = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__TRG_74_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.polarsys.capella.core.data.cs.ComponentPkg_ownedParts_Part": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("Oa2Sa_transition_actors_recursively__TRG_74_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.polarsys.capella.core.data.ctx.SystemComponent) {
			...
			if(formerMatches_1 != null) {
				...
				formerMatches_1 = formerMatches_1.stream().filter(m -> !constraint_checker.check(m) || !constraint_check_0.check(m) || !constraint_checker_0.check(m)).collect(Collectors.toList());
	...
	public boolean constraint_checker_method(HMatch match) {
		org.polarsys.capella.core.data.ctx.SystemComponent trg_system_component = (org.polarsys.capella.core.data.ctx.SystemComponent) match.getNodes()[1];
		org.polarsys.capella.core.data.cs.Part trg_system_part = (org.polarsys.capella.core.data.cs.Part) match.getNodes()[3];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_21 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_21.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trg_system_component.getName(), "java.lang.String"));
		csp_21.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trg_system_part.getName(), "java.lang.String"));
		csp_21.solve();
	...
	public boolean constraint_check_1_method(HMatch match) {
		org.polarsys.capella.core.data.ctx.SystemComponentPkg trg_system_component_pkg = (org.polarsys.capella.core.data.ctx.SystemComponentPkg) match.getNodes()[2];
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_20.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trg_system_component.getName(), "java.lang.String"));
		csp_20.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trg_system_part.getName(), "java.lang.String"));
		csp_20.solve();
