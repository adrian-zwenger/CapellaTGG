...
public class Oa2Sa_transition_actors__SRC_61_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						...
						edge_explorer_4_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.polarsys.capella.core.data.oa.EntityPkg) return edge_explorer_4_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("Oa2Sa_transition_actors__FWD_66_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("Oa2Sa_transition_actors__SRC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "EntityPkg_object_SP1": 
				{
					...
					// src_entity_pkg
					HMatch match_0 = new LocalSearchMatch("Oa2Sa_transition_actors__SRC_61_localSearch", 4);
			...
			case "OperationalAnalysis_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// src_oa_arch
						HMatch match_1 = new LocalSearchMatch("Oa2Sa_transition_actors__SRC_61_localSearch", 4);
			...
			case "Entity_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// src_oa_entity
						HMatch match_2 = new LocalSearchMatch("Oa2Sa_transition_actors__SRC_61_localSearch", 4);
			...
			case "Part_object_SP1": 
				{
					...
					// src_oa_part
					HMatch match_3 = new LocalSearchMatch("Oa2Sa_transition_actors__SRC_61_localSearch", 4);
		...
		switch(match.creator) {
			...
			case "Oa2Sa_transition_actors_src_oa_entity_ownedEntities_incoming_SRC__FILTER_NAC_SRC_48_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("Oa2Sa_transition_actors__SRC_61_localSearch", 4);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.polarsys.capella.core.data.oa.OperationalAnalysis_ownedEntityPkg_EntityPkg": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("Oa2Sa_transition_actors__SRC_61_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_10.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_entity_pkg.getName(), "java.lang.String"));
		csp_10.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "Operational Entities", "java.lang.String"));
		csp_10.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_11.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_oa_entity.getName(), "java.lang.String"));
		csp_11.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, src_oa_part.getName(), "java.lang.String"));
		csp_11.solve();
