 ...
 * </p>
 * <ul>
 *   <li>{@link modellingcore.impl.AbstractParameterImpl#isIsException <em>Is Exception</em>}</li>
 *   <li>{@link modellingcore.impl.AbstractParameterImpl#isIsStream <em>Is Stream</em>}</li>
 *   <li>{@link modellingcore.impl.AbstractParameterImpl#isIsOptional <em>Is Optional</em>}</li>
 *   <li>{@link modellingcore.impl.AbstractParameterImpl#getKindOfRate <em>Kind Of Rate</em>}</li>
 *   <li>{@link modellingcore.impl.AbstractParameterImpl#getEffect <em>Effect</em>}</li>
 *   <li>{@link modellingcore.impl.AbstractParameterImpl#getRate <em>Rate</em>}</li>
 *   <li>{@link modellingcore.impl.AbstractParameterImpl#getProbability <em>Probability</em>}</li>
 *   <li>{@link modellingcore.impl.AbstractParameterImpl#getParameterSet <em>Parameter Set</em>}</li>
 * </ul>
 *
 * @generated
 */
