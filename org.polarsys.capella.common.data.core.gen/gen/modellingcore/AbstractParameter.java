 ...
 * </p>
 * <ul>
 *   <li>{@link modellingcore.AbstractParameter#isIsException <em>Is Exception</em>}</li>
 *   <li>{@link modellingcore.AbstractParameter#isIsStream <em>Is Stream</em>}</li>
 *   <li>{@link modellingcore.AbstractParameter#isIsOptional <em>Is Optional</em>}</li>
 *   <li>{@link modellingcore.AbstractParameter#getKindOfRate <em>Kind Of Rate</em>}</li>
 *   <li>{@link modellingcore.AbstractParameter#getEffect <em>Effect</em>}</li>
 *   <li>{@link modellingcore.AbstractParameter#getRate <em>Rate</em>}</li>
 *   <li>{@link modellingcore.AbstractParameter#getProbability <em>Probability</em>}</li>
 *   <li>{@link modellingcore.AbstractParameter#getParameterSet <em>Parameter Set</em>}</li>
 * </ul>
 *
 * @see modellingcore.ModellingcorePackage#getAbstractParameter()
 * @model abstract="true"
...
public interface AbstractParameter extends AbstractTypedElement {
	 ...
	 * @see modellingcore.ModellingcorePackage#getAbstractParameter_IsException()
	...
	/**
	 * Sets the value of the '{@link modellingcore.AbstractParameter#isIsException <em>Is Exception</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see modellingcore.ModellingcorePackage#getAbstractParameter_IsStream()
	...
	/**
	 * Sets the value of the '{@link modellingcore.AbstractParameter#isIsStream <em>Is Stream</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see modellingcore.ModellingcorePackage#getAbstractParameter_IsOptional()
	...
	/**
	 * Sets the value of the '{@link modellingcore.AbstractParameter#isIsOptional <em>Is Optional</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link modellingcore.RateKind}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Kind Of Rate</em>' attribute.
	 * @see modellingcore.RateKind
	 * @see #setKindOfRate(RateKind)
	 * @see modellingcore.ModellingcorePackage#getAbstractParameter_KindOfRate()
	...
	/**
	 * Sets the value of the '{@link modellingcore.AbstractParameter#getKindOfRate <em>Kind Of Rate</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link modellingcore.ParameterEffectKind}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Effect</em>' attribute.
	 * @see modellingcore.ParameterEffectKind
	 * @see #setEffect(ParameterEffectKind)
	 * @see modellingcore.ModellingcorePackage#getAbstractParameter_Effect()
	...
	/**
	 * Sets the value of the '{@link modellingcore.AbstractParameter#getEffect <em>Effect</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see modellingcore.ModellingcorePackage#getAbstractParameter_Rate()
	...
	/**
	 * Sets the value of the '{@link modellingcore.AbstractParameter#getRate <em>Rate</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see modellingcore.ModellingcorePackage#getAbstractParameter_Probability()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link modellingcore.AbstractParameter#getProbability <em>Probability</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link modellingcore.AbstractParameterSet}.
	 * It is bidirectional and its opposite is '{@link modellingcore.AbstractParameterSet#getParameters <em>Parameters</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Parameter Set</em>' reference list.
	 * @see modellingcore.ModellingcorePackage#getAbstractParameter_ParameterSet()
