 ...
 * </p>
 * <ul>
 *   <li>{@link behavior.AbstractBehavior#isIsControlOperator <em>Is Control Operator</em>}</li>
 *   <li>{@link behavior.AbstractBehavior#getOwnedParameterSet <em>Owned Parameter Set</em>}</li>
 *   <li>{@link behavior.AbstractBehavior#getOwnedParameter <em>Owned Parameter</em>}</li>
 * </ul>
 *
 * @see behavior.BehaviorPackage#getAbstractBehavior()
...
public interface AbstractBehavior extends AbstractNamedElement {
	 ...
	 * @see behavior.BehaviorPackage#getAbstractBehavior_IsControlOperator()
	...
	/**
	 * Sets the value of the '{@link behavior.AbstractBehavior#isIsControlOperator <em>Is Control Operator</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see behavior.BehaviorPackage#getAbstractBehavior_OwnedParameterSet()
	 ...
	 * @see behavior.BehaviorPackage#getAbstractBehavior_OwnedParameter()
