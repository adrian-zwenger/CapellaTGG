 ...
 * </p>
 * <ul>
 *   <li>{@link re.impl.CatalogElementImpl#getOwnedElements <em>Owned Elements</em>}</li>
 *   <li>{@link re.impl.CatalogElementImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link re.impl.CatalogElementImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link re.impl.CatalogElementImpl#getEnvironment <em>Environment</em>}</li>
 *   <li>{@link re.impl.CatalogElementImpl#getSuffix <em>Suffix</em>}</li>
 *   <li>{@link re.impl.CatalogElementImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link re.impl.CatalogElementImpl#isReadOnly <em>Read Only</em>}</li>
 *   <li>{@link re.impl.CatalogElementImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link re.impl.CatalogElementImpl#getTags <em>Tags</em>}</li>
 *   <li>{@link re.impl.CatalogElementImpl#getOrigin <em>Origin</em>}</li>
 *   <li>{@link re.impl.CatalogElementImpl#getCurrentCompliancy <em>Current Compliancy</em>}</li>
 *   <li>{@link re.impl.CatalogElementImpl#getDefaultReplicaCompliancy <em>Default Replica Compliancy</em>}</li>
 *   <li>{@link re.impl.CatalogElementImpl#getOwnedLinks <em>Owned Links</em>}</li>
 *   <li>{@link re.impl.CatalogElementImpl#getReferencedElements <em>Referenced Elements</em>}</li>
 *   <li>{@link re.impl.CatalogElementImpl#getReplicatedElements <em>Replicated Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CatalogElementImpl extends ReDescriptionElementImpl implements CatalogElement {
	...
	/**
	 * The cached value of the '{@link #getReplicatedElements() <em>Replicated Elements</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getReplicatedElements()
	 * @generated
	 * @ordered
	 */
	protected EList<CatalogElement> replicatedElements;
	...
	public EList<CatalogElement> getOwnedElements() {
		if (ownedElements == null) {
			ownedElements = new EObjectContainmentEList<CatalogElement>(CatalogElement.class, this, RePackage.CATALOG_ELEMENT__OWNED_ELEMENTS);
		}
	...
	public EList<CatalogElementLink> getOwnedLinks() {
		if (ownedLinks == null) {
			ownedLinks = new EObjectContainmentEList<CatalogElementLink>(CatalogElementLink.class, this, RePackage.CATALOG_ELEMENT__OWNED_LINKS);
		}
		return ownedLinks;
	}
	...
	public EList<EObject> getReferencedElements() {
		if (referencedElements == null) {
			referencedElements = new EObjectResolvingEList<EObject>(EObject.class, this, RePackage.CATALOG_ELEMENT__REFERENCED_ELEMENTS);
		}
	...
	public EList<CatalogElement> getReplicatedElements() {
		if (replicatedElements == null) {
			replicatedElements = new EObjectResolvingEList<CatalogElement>(CatalogElement.class, this, RePackage.CATALOG_ELEMENT__REPLICATED_ELEMENTS);
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case RePackage.CATALOG_ELEMENT__REPLICATED_ELEMENTS:
				return replicatedElements != null && !replicatedElements.isEmpty();
		}
