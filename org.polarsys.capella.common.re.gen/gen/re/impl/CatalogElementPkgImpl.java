 ...
 * </p>
 * <ul>
 *   <li>{@link re.impl.CatalogElementPkgImpl#getOwnedElements <em>Owned Elements</em>}</li>
 *   <li>{@link re.impl.CatalogElementPkgImpl#getOwnedElementPkgs <em>Owned Element Pkgs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CatalogElementPkgImpl extends ReNamedElementImpl implements CatalogElementPkg {
	...
	public EList<CatalogElement> getOwnedElements() {
		if (ownedElements == null) {
			ownedElements = new EObjectContainmentEList<CatalogElement>(CatalogElement.class, this, RePackage.CATALOG_ELEMENT_PKG__OWNED_ELEMENTS);
		}
	...
	public EList<CatalogElementPkg> getOwnedElementPkgs() {
		if (ownedElementPkgs == null) {
			ownedElementPkgs = new EObjectContainmentEList<CatalogElementPkg>(CatalogElementPkg.class, this, RePackage.CATALOG_ELEMENT_PKG__OWNED_ELEMENT_PKGS);
		}
