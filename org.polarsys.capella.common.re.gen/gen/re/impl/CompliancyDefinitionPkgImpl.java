 ...
 * </p>
 * <ul>
 *   <li>{@link re.impl.CompliancyDefinitionPkgImpl#getOwnedDefinitions <em>Owned Definitions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompliancyDefinitionPkgImpl extends ReNamedElementImpl implements CompliancyDefinitionPkg {
	...
	public EList<CompliancyDefinition> getOwnedDefinitions() {
		if (ownedDefinitions == null) {
			ownedDefinitions = new EObjectContainmentEList<CompliancyDefinition>(CompliancyDefinition.class, this, RePackage.COMPLIANCY_DEFINITION_PKG__OWNED_DEFINITIONS);
		}
