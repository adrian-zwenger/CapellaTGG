...
import libraries.LibrariesFactory;
import libraries.LibrariesPackage;
import libraries.LibraryAbstractElement;
...
public class LibrariesPackageImpl extends EPackageImpl implements LibrariesPackage {
	 ...
	 * @see libraries.LibrariesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(modelInformationEClass, ModelInformation.class, "ModelInformation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getModelInformation_OwnedReferences(), this.getLibraryReference(), null, "ownedReferences", null, 0, -1, ModelInformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getModelInformation_Version(), this.getModelVersion(), null, "version", null, 0, 1, ModelInformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getLibraryReference_Library(), this.getModelInformation(), null, "library", null, 1, 1, LibraryReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLibraryReference_AccessPolicy(), this.getAccessPolicy(), "accessPolicy", null, 1, 1, LibraryReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLibraryReference_Version(), this.getModelVersion(), null, "version", null, 0, 1, LibraryReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(modelVersionEClass, ModelVersion.class, "ModelVersion", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getModelVersion_MajorVersionNumber(), ecorePackage.getEInt(), "majorVersionNumber", null, 1, 1, ModelVersion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getModelVersion_MinorVersionNumber(), ecorePackage.getEInt(), "minorVersionNumber", null, 1, 1, ModelVersion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getModelVersion_LastModifiedFileStamp(), ecorePackage.getELong(), "lastModifiedFileStamp", null, 0, 1, ModelVersion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(libraryAbstractElementEClass, LibraryAbstractElement.class, "LibraryAbstractElement", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLibraryAbstractElement_Id(), ecorePackage.getEString(), "id", null, 0, 1, LibraryAbstractElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Initialize enums and add enum literals
		initEEnum(accessPolicyEEnum, AccessPolicy.class, "AccessPolicy");
	...
	protected void createConstraintAnnotations() {
		...
		addAnnotation
		  (modelInformationEClass,
		   source,
		   new String[] {
			   "ExtendedElement", "http://www.polarsys.org/capella/core/modeller/5.0.0#//Project"
		   });
	}
	...
	protected void createConstraintMappingAnnotations() {
		...
		addAnnotation
		  (modelInformationEClass,
		   source,
		   new String[] {
			   "Mapping", "platform:/resource/org.polarsys.capella.core.data.gen/model/CapellaModeller.ecore#//Project"
		   });
	}
