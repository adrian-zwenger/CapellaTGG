...
public class FunctionInputPortImpl extends FunctionPortImpl implements FunctionInputPort {
	...
	/**
	 * The cached value of the '{@link #getIncomingFunctionalExchanges() <em>Incoming Functional Exchanges</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getIncomingFunctionalExchanges()
	 * @generated
	 * @ordered
	 */
	protected EList<FunctionalExchange> incomingFunctionalExchanges;
		...
		if (inActivityPartition != null && inActivityPartition.eIsProxy()) {
			...
			if (inActivityPartition != oldInActivityPartition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FaPackage.FUNCTION_INPUT_PORT__IN_ACTIVITY_PARTITION, oldInActivityPartition, inActivityPartition));
			}
		}
	...
	public InterruptibleActivityRegion getInInterruptibleRegion() {
		if (inInterruptibleRegion != null && inInterruptibleRegion.eIsProxy()) {
			...
			if (inInterruptibleRegion != oldInInterruptibleRegion) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FaPackage.FUNCTION_INPUT_PORT__IN_INTERRUPTIBLE_REGION, oldInInterruptibleRegion, inInterruptibleRegion));
			}
		}
	...
	public InterruptibleActivityRegion getInStructuredNode() {
		if (inStructuredNode != null && inStructuredNode.eIsProxy()) {
			...
			if (inStructuredNode != oldInStructuredNode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FaPackage.FUNCTION_INPUT_PORT__IN_STRUCTURED_NODE, oldInStructuredNode, inStructuredNode));
			}
		}
	...
	public EList<FunctionalExchange> getIncomingFunctionalExchanges() {
		if (incomingFunctionalExchanges == null) {
			incomingFunctionalExchanges = new EObjectResolvingEList<FunctionalExchange>(FunctionalExchange.class, this, FaPackage.FUNCTION_INPUT_PORT__INCOMING_FUNCTIONAL_EXCHANGES);
		}
		return incomingFunctionalExchanges;
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case FaPackage.FUNCTION_INPUT_PORT__INCOMING_FUNCTIONAL_EXCHANGES:
				return incomingFunctionalExchanges != null && !incomingFunctionalExchanges.isEmpty();
		}
