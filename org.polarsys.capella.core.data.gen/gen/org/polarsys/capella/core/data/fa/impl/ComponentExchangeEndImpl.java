...
import modellingcore.impl.InformationsExchangerImpl;
...
public class ComponentExchangeEndImpl extends InformationsExchangerImpl implements ComponentExchangeEnd {
	...
	public EList<AbstractTrace> getIncomingTraces() {
		if (incomingTraces == null) {
			incomingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, FaPackage.COMPONENT_EXCHANGE_END__INCOMING_TRACES);
		}
	...
	public EList<AbstractTrace> getOutgoingTraces() {
		if (outgoingTraces == null) {
			outgoingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, FaPackage.COMPONENT_EXCHANGE_END__OUTGOING_TRACES);
		}
