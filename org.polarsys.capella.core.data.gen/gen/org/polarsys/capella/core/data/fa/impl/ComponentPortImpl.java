...
public class ComponentPortImpl extends PortImpl implements ComponentPort {
	...
	/**
	 * The cached value of the '{@link #getDelegatingComponentPorts() <em>Delegating Component Ports</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getDelegatingComponentPorts()
	 * @generated
	 * @ordered
	 */
	protected EList<ComponentPort> delegatingComponentPorts;

	/**
	 * The cached value of the '{@link #getAllocatingPhysicalPorts() <em>Allocating Physical Ports</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAllocatingPhysicalPorts()
	 * @generated
	 * @ordered
	 */
	protected EList<PhysicalPort> allocatingPhysicalPorts;
	...
	/**
	 * The cached value of the '{@link #getRealizingComponentPorts() <em>Realizing Component Ports</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getRealizingComponentPorts()
	 * @generated
	 * @ordered
	 */
	protected EList<ComponentPort> realizingComponentPorts;
	...
	public EList<AbstractInformationFlow> getIncomingInformationFlows() {
		if (incomingInformationFlows == null) {
			incomingInformationFlows = new EObjectResolvingEList<AbstractInformationFlow>(AbstractInformationFlow.class, this, FaPackage.COMPONENT_PORT__INCOMING_INFORMATION_FLOWS);
		}
	...
	public EList<AbstractInformationFlow> getOutgoingInformationFlows() {
		if (outgoingInformationFlows == null) {
			outgoingInformationFlows = new EObjectResolvingEList<AbstractInformationFlow>(AbstractInformationFlow.class, this, FaPackage.COMPONENT_PORT__OUTGOING_INFORMATION_FLOWS);
		}
	...
	public EList<AbstractInformationFlow> getInformationFlows() {
		if (informationFlows == null) {
			informationFlows = new EObjectResolvingEList<AbstractInformationFlow>(AbstractInformationFlow.class, this, FaPackage.COMPONENT_PORT__INFORMATION_FLOWS);
		}
	...
	public Association getAssociation() {
		if (association != null && association.eIsProxy()) {
			...
			if (association != oldAssociation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FaPackage.COMPONENT_PORT__ASSOCIATION, oldAssociation, association));
			}
		}
		return association;
	}
	...
	public EList<FunctionPort> getAllocatedFunctionPorts() {
		if (allocatedFunctionPorts == null) {
			allocatedFunctionPorts = new EObjectWithInverseResolvingEList.ManyInverse<FunctionPort>(FunctionPort.class, this, FaPackage.COMPONENT_PORT__ALLOCATED_FUNCTION_PORTS, FaPackage.FUNCTION_PORT__ALLOCATOR_COMPONENT_PORTS);
		}
	...
	public EList<ComponentPort> getDelegatedComponentPorts() {
		if (delegatedComponentPorts == null) {
			delegatedComponentPorts = new EObjectWithInverseResolvingEList.ManyInverse<ComponentPort>(ComponentPort.class, this, FaPackage.COMPONENT_PORT__DELEGATED_COMPONENT_PORTS, FaPackage.COMPONENT_PORT__DELEGATING_COMPONENT_PORTS);
		}
	...
	public EList<ComponentPort> getDelegatingComponentPorts() {
		if (delegatingComponentPorts == null) {
			delegatingComponentPorts = new EObjectWithInverseResolvingEList.ManyInverse<ComponentPort>(ComponentPort.class, this, FaPackage.COMPONENT_PORT__DELEGATING_COMPONENT_PORTS, FaPackage.COMPONENT_PORT__DELEGATED_COMPONENT_PORTS);
		}
		return delegatingComponentPorts;
	}
	...
	public EList<PhysicalPort> getAllocatingPhysicalPorts() {
		if (allocatingPhysicalPorts == null) {
			allocatingPhysicalPorts = new EObjectWithInverseResolvingEList.ManyInverse<PhysicalPort>(PhysicalPort.class, this, FaPackage.COMPONENT_PORT__ALLOCATING_PHYSICAL_PORTS, CsPackage.PHYSICAL_PORT__ALLOCATED_COMPONENT_PORTS);
		}
		return allocatingPhysicalPorts;
	}
	...
	public EList<ComponentPort> getRealizedComponentPorts() {
		if (realizedComponentPorts == null) {
			realizedComponentPorts = new EObjectWithInverseResolvingEList.ManyInverse<ComponentPort>(ComponentPort.class, this, FaPackage.COMPONENT_PORT__REALIZED_COMPONENT_PORTS, FaPackage.COMPONENT_PORT__REALIZING_COMPONENT_PORTS);
		}
	...
	public EList<ComponentPort> getRealizingComponentPorts() {
		if (realizingComponentPorts == null) {
			realizingComponentPorts = new EObjectWithInverseResolvingEList.ManyInverse<ComponentPort>(ComponentPort.class, this, FaPackage.COMPONENT_PORT__REALIZING_COMPONENT_PORTS, FaPackage.COMPONENT_PORT__REALIZED_COMPONENT_PORTS);
		}
		return realizingComponentPorts;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FaPackage.COMPONENT_PORT__ALLOCATED_FUNCTION_PORTS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getAllocatedFunctionPorts()).basicAdd(otherEnd, msgs);
			case FaPackage.COMPONENT_PORT__DELEGATED_COMPONENT_PORTS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getDelegatedComponentPorts()).basicAdd(otherEnd, msgs);
			case FaPackage.COMPONENT_PORT__DELEGATING_COMPONENT_PORTS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getDelegatingComponentPorts()).basicAdd(otherEnd, msgs);
			case FaPackage.COMPONENT_PORT__ALLOCATING_PHYSICAL_PORTS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getAllocatingPhysicalPorts()).basicAdd(otherEnd, msgs);
			case FaPackage.COMPONENT_PORT__REALIZED_COMPONENT_PORTS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getRealizedComponentPorts()).basicAdd(otherEnd, msgs);
			case FaPackage.COMPONENT_PORT__REALIZING_COMPONENT_PORTS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getRealizingComponentPorts()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FaPackage.COMPONENT_PORT__ALLOCATED_FUNCTION_PORTS:
				return ((InternalEList<?>)getAllocatedFunctionPorts()).basicRemove(otherEnd, msgs);
			case FaPackage.COMPONENT_PORT__DELEGATED_COMPONENT_PORTS:
				return ((InternalEList<?>)getDelegatedComponentPorts()).basicRemove(otherEnd, msgs);
			case FaPackage.COMPONENT_PORT__DELEGATING_COMPONENT_PORTS:
				return ((InternalEList<?>)getDelegatingComponentPorts()).basicRemove(otherEnd, msgs);
			case FaPackage.COMPONENT_PORT__ALLOCATING_PHYSICAL_PORTS:
				return ((InternalEList<?>)getAllocatingPhysicalPorts()).basicRemove(otherEnd, msgs);
			case FaPackage.COMPONENT_PORT__REALIZED_COMPONENT_PORTS:
				return ((InternalEList<?>)getRealizedComponentPorts()).basicRemove(otherEnd, msgs);
			case FaPackage.COMPONENT_PORT__REALIZING_COMPONENT_PORTS:
				return ((InternalEList<?>)getRealizingComponentPorts()).basicRemove(otherEnd, msgs);
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case FaPackage.COMPONENT_PORT__DELEGATING_COMPONENT_PORTS:
				return delegatingComponentPorts != null && !delegatingComponentPorts.isEmpty();
			case FaPackage.COMPONENT_PORT__ALLOCATING_PHYSICAL_PORTS:
				return allocatingPhysicalPorts != null && !allocatingPhysicalPorts.isEmpty();
			case FaPackage.COMPONENT_PORT__REALIZED_COMPONENT_PORTS:
				return realizedComponentPorts != null && !realizedComponentPorts.isEmpty();
			case FaPackage.COMPONENT_PORT__REALIZING_COMPONENT_PORTS:
				return realizingComponentPorts != null && !realizingComponentPorts.isEmpty();
		}
