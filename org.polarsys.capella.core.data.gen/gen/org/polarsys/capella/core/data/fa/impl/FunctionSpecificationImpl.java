...
public class FunctionSpecificationImpl extends NamedElementImpl implements FunctionSpecification {
	...
	/**
	 * The cached value of the '{@link #getSubFunctionSpecifications() <em>Sub Function Specifications</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getSubFunctionSpecifications()
	 * @generated
	 * @ordered
	 */
	protected EList<FunctionSpecification> subFunctionSpecifications;
	...
	public EList<GenericTrace> getContainedGenericTraces() {
		if (containedGenericTraces == null) {
			containedGenericTraces = new EObjectResolvingEList<GenericTrace>(GenericTrace.class, this, FaPackage.FUNCTION_SPECIFICATION__CONTAINED_GENERIC_TRACES);
		}
	...
	public EList<RequirementsTrace> getContainedRequirementsTraces() {
		if (containedRequirementsTraces == null) {
			containedRequirementsTraces = new EObjectResolvingEList<RequirementsTrace>(RequirementsTrace.class, this, FaPackage.FUNCTION_SPECIFICATION__CONTAINED_REQUIREMENTS_TRACES);
		}
	...
	public EList<StructuredActivityNode> getOwnedStructuredNodes() {
		if (ownedStructuredNodes == null) {
			ownedStructuredNodes = new EObjectResolvingEList<StructuredActivityNode>(StructuredActivityNode.class, this, FaPackage.FUNCTION_SPECIFICATION__OWNED_STRUCTURED_NODES);
		}
	...
	public EList<FunctionSpecification> getSubFunctionSpecifications() {
		if (subFunctionSpecifications == null) {
			subFunctionSpecifications = new EObjectEList<FunctionSpecification>(FunctionSpecification.class, this, FaPackage.FUNCTION_SPECIFICATION__SUB_FUNCTION_SPECIFICATIONS);
		}
		return subFunctionSpecifications;
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case FaPackage.FUNCTION_SPECIFICATION__SUB_FUNCTION_SPECIFICATIONS:
				return subFunctionSpecifications != null && !subFunctionSpecifications.isEmpty();
		}
