...
public abstract class AbstractFunctionImpl extends NamedElementImpl implements AbstractFunction {
	 ...
	 * @ordered
	 */
	protected EList<AbstractFunction> subFunctions;

	/**
	 * The cached value of the '{@link #getOutFunctionRealizations() <em>Out Function Realizations</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getOutFunctionRealizations()
	 * @generated
	 * @ordered
	 */
	protected EList<FunctionRealization> outFunctionRealizations;

	/**
	 * The cached value of the '{@link #getInFunctionRealizations() <em>In Function Realizations</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getInFunctionRealizations()
	 * @generated
	 * @ordered
	 */
	protected EList<FunctionRealization> inFunctionRealizations;

	/**
	 * The cached value of the '{@link #getComponentFunctionalAllocations() <em>Component Functional Allocations</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getComponentFunctionalAllocations()
	 * @generated
	 * @ordered
	 */
	protected EList<ComponentFunctionalAllocation> componentFunctionalAllocations;

	/**
	 * The cached value of the '{@link #getAllocationBlocks() <em>Allocation Blocks</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAllocationBlocks()
	 * @generated
	 * @ordered
	 */
	protected EList<AbstractFunctionalBlock> allocationBlocks;
	...
	/**
	 * The cached value of the '{@link #getLinkedFunctionSpecification() <em>Linked Function Specification</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getLinkedFunctionSpecification()
	 * @generated
	 * @ordered
	 */
	protected FunctionSpecification linkedFunctionSpecification;
	...
	public EList<GenericTrace> getContainedGenericTraces() {
		if (containedGenericTraces == null) {
			containedGenericTraces = new EObjectResolvingEList<GenericTrace>(GenericTrace.class, this, FaPackage.ABSTRACT_FUNCTION__CONTAINED_GENERIC_TRACES);
		}
	...
	public EList<RequirementsTrace> getContainedRequirementsTraces() {
		if (containedRequirementsTraces == null) {
			containedRequirementsTraces = new EObjectResolvingEList<RequirementsTrace>(RequirementsTrace.class, this, FaPackage.ABSTRACT_FUNCTION__CONTAINED_REQUIREMENTS_TRACES);
		}
	...
	public EList<Involvement> getInvolvingInvolvements() {
		if (involvingInvolvements == null) {
			involvingInvolvements = new EObjectResolvingEList<Involvement>(Involvement.class, this, FaPackage.ABSTRACT_FUNCTION__INVOLVING_INVOLVEMENTS);
		}
	...
	public Association getAssociation() {
		if (association != null && association.eIsProxy()) {
			...
			if (association != oldAssociation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FaPackage.ABSTRACT_FUNCTION__ASSOCIATION, oldAssociation, association));
			}
		}
		return association;
	}
	...
	public EList<InstanceRole> getRepresentingInstanceRoles() {
		if (representingInstanceRoles == null) {
			representingInstanceRoles = new EObjectResolvingEList<InstanceRole>(InstanceRole.class, this, FaPackage.ABSTRACT_FUNCTION__REPRESENTING_INSTANCE_ROLES);
		}
	...
	public ActivityPartition getInActivityPartition() {
		if (inActivityPartition != null && inActivityPartition.eIsProxy()) {
			...
			if (inActivityPartition != oldInActivityPartition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FaPackage.ABSTRACT_FUNCTION__IN_ACTIVITY_PARTITION, oldInActivityPartition, inActivityPartition));
			}
		}
	...
	public InterruptibleActivityRegion getInInterruptibleRegion() {
		if (inInterruptibleRegion != null && inInterruptibleRegion.eIsProxy()) {
			...
			if (inInterruptibleRegion != oldInInterruptibleRegion) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FaPackage.ABSTRACT_FUNCTION__IN_INTERRUPTIBLE_REGION, oldInInterruptibleRegion, inInterruptibleRegion));
			}
		}
	...
	public InterruptibleActivityRegion getInStructuredNode() {
		if (inStructuredNode != null && inStructuredNode.eIsProxy()) {
			...
			if (inStructuredNode != oldInStructuredNode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FaPackage.ABSTRACT_FUNCTION__IN_STRUCTURED_NODE, oldInStructuredNode, inStructuredNode));
			}
		}
	...
	public EList<AbstractTypedElement> getAbstractTypedElements() {
		if (abstractTypedElements == null) {
			abstractTypedElements = new EObjectResolvingEList<AbstractTypedElement>(AbstractTypedElement.class, this, FaPackage.ABSTRACT_FUNCTION__ABSTRACT_TYPED_ELEMENTS);
		}
	...
	public EList<AbstractFunction> getSubFunctions() {
		if (subFunctions == null) {
			subFunctions = new EObjectResolvingEList<AbstractFunction>(AbstractFunction.class, this, FaPackage.ABSTRACT_FUNCTION__SUB_FUNCTIONS);
		}
		return subFunctions;
	}
	...
	public EList<FunctionRealization> getOutFunctionRealizations() {
		if (outFunctionRealizations == null) {
			outFunctionRealizations = new EObjectWithInverseResolvingEList<FunctionRealization>(FunctionRealization.class, this, FaPackage.ABSTRACT_FUNCTION__OUT_FUNCTION_REALIZATIONS, FaPackage.FUNCTION_REALIZATION__ALLOCATING_FUNCTION);
		}
		return outFunctionRealizations;
	}
	...
	public EList<FunctionRealization> getInFunctionRealizations() {
		if (inFunctionRealizations == null) {
			inFunctionRealizations = new EObjectWithInverseResolvingEList<FunctionRealization>(FunctionRealization.class, this, FaPackage.ABSTRACT_FUNCTION__IN_FUNCTION_REALIZATIONS, FaPackage.FUNCTION_REALIZATION__ALLOCATED_FUNCTION);
		}
		return inFunctionRealizations;
	}
	...
	public EList<ComponentFunctionalAllocation> getComponentFunctionalAllocations() {
		if (componentFunctionalAllocations == null) {
			componentFunctionalAllocations = new EObjectWithInverseResolvingEList<ComponentFunctionalAllocation>(ComponentFunctionalAllocation.class, this, FaPackage.ABSTRACT_FUNCTION__COMPONENT_FUNCTIONAL_ALLOCATIONS, FaPackage.COMPONENT_FUNCTIONAL_ALLOCATION__FUNCTION);
		}
		return componentFunctionalAllocations;
	}
	...
	public EList<AbstractFunctionalBlock> getAllocationBlocks() {
		if (allocationBlocks == null) {
			allocationBlocks = new EObjectWithInverseResolvingEList.ManyInverse<AbstractFunctionalBlock>(AbstractFunctionalBlock.class, this, FaPackage.ABSTRACT_FUNCTION__ALLOCATION_BLOCKS, FaPackage.ABSTRACT_FUNCTIONAL_BLOCK__ALLOCATED_FUNCTIONS);
		}
	...
	public EList<Capability> getInvolvingCapabilities() {
		if (involvingCapabilities == null) {
			involvingCapabilities = new EObjectResolvingEList<Capability>(Capability.class, this, FaPackage.ABSTRACT_FUNCTION__INVOLVING_CAPABILITIES);
		}
	...
	public EList<CapabilityRealization> getInvolvingCapabilityRealizations() {
		if (involvingCapabilityRealizations == null) {
			involvingCapabilityRealizations = new EObjectResolvingEList<CapabilityRealization>(CapabilityRealization.class, this, FaPackage.ABSTRACT_FUNCTION__INVOLVING_CAPABILITY_REALIZATIONS);
		}
	...
	public EList<FunctionalChain> getInvolvingFunctionalChains() {
		if (involvingFunctionalChains == null) {
			involvingFunctionalChains = new EObjectWithInverseResolvingEList.ManyInverse<FunctionalChain>(FunctionalChain.class, this, FaPackage.ABSTRACT_FUNCTION__INVOLVING_FUNCTIONAL_CHAINS, FaPackage.FUNCTIONAL_CHAIN__INVOLVED_FUNCTIONS);
		}
	...
	public FunctionSpecification getLinkedFunctionSpecification() {
		return linkedFunctionSpecification;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FaPackage.ABSTRACT_FUNCTION__OUT_FUNCTION_REALIZATIONS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getOutFunctionRealizations()).basicAdd(otherEnd, msgs);
			case FaPackage.ABSTRACT_FUNCTION__IN_FUNCTION_REALIZATIONS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getInFunctionRealizations()).basicAdd(otherEnd, msgs);
			case FaPackage.ABSTRACT_FUNCTION__COMPONENT_FUNCTIONAL_ALLOCATIONS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getComponentFunctionalAllocations()).basicAdd(otherEnd, msgs);
			case FaPackage.ABSTRACT_FUNCTION__ALLOCATION_BLOCKS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getAllocationBlocks()).basicAdd(otherEnd, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FaPackage.ABSTRACT_FUNCTION__OUT_FUNCTION_REALIZATIONS:
				return ((InternalEList<?>)getOutFunctionRealizations()).basicRemove(otherEnd, msgs);
			case FaPackage.ABSTRACT_FUNCTION__IN_FUNCTION_REALIZATIONS:
				return ((InternalEList<?>)getInFunctionRealizations()).basicRemove(otherEnd, msgs);
			case FaPackage.ABSTRACT_FUNCTION__COMPONENT_FUNCTIONAL_ALLOCATIONS:
				return ((InternalEList<?>)getComponentFunctionalAllocations()).basicRemove(otherEnd, msgs);
			case FaPackage.ABSTRACT_FUNCTION__ALLOCATION_BLOCKS:
				return ((InternalEList<?>)getAllocationBlocks()).basicRemove(otherEnd, msgs);
			case FaPackage.ABSTRACT_FUNCTION__INVOLVING_FUNCTIONAL_CHAINS:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case FaPackage.ABSTRACT_FUNCTION__OUT_FUNCTION_REALIZATIONS:
				return outFunctionRealizations != null && !outFunctionRealizations.isEmpty();
			case FaPackage.ABSTRACT_FUNCTION__IN_FUNCTION_REALIZATIONS:
				return inFunctionRealizations != null && !inFunctionRealizations.isEmpty();
			case FaPackage.ABSTRACT_FUNCTION__COMPONENT_FUNCTIONAL_ALLOCATIONS:
				return componentFunctionalAllocations != null && !componentFunctionalAllocations.isEmpty();
			case FaPackage.ABSTRACT_FUNCTION__ALLOCATION_BLOCKS:
				return allocationBlocks != null && !allocationBlocks.isEmpty();
			case FaPackage.ABSTRACT_FUNCTION__AVAILABLE_IN_STATES:
			...
			case FaPackage.ABSTRACT_FUNCTION__LINKED_FUNCTION_SPECIFICATION:
				return linkedFunctionSpecification != null;
		}
