...
public class SequenceLinkImpl extends ModelElementImpl implements SequenceLink {
	...
	public EList<AbstractTrace> getIncomingTraces() {
		if (incomingTraces == null) {
			incomingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, FaPackage.SEQUENCE_LINK__INCOMING_TRACES);
		}
	...
	public EList<AbstractTrace> getOutgoingTraces() {
		if (outgoingTraces == null) {
			outgoingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, FaPackage.SEQUENCE_LINK__OUTGOING_TRACES);
		}
	...
	public EList<Requirement> getAppliedRequirements() {
		if (appliedRequirements == null) {
			appliedRequirements = new EObjectResolvingEList<Requirement>(Requirement.class, this, FaPackage.SEQUENCE_LINK__APPLIED_REQUIREMENTS);
		}
