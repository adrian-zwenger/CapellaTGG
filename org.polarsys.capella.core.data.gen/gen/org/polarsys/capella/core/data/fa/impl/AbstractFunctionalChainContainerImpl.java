...
public abstract class AbstractFunctionalChainContainerImpl extends ModelElementImpl implements AbstractFunctionalChainContainer {
	...
	public EList<AbstractTrace> getIncomingTraces() {
		if (incomingTraces == null) {
			incomingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, FaPackage.ABSTRACT_FUNCTIONAL_CHAIN_CONTAINER__INCOMING_TRACES);
		}
	...
	public EList<AbstractTrace> getOutgoingTraces() {
		if (outgoingTraces == null) {
			outgoingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, FaPackage.ABSTRACT_FUNCTIONAL_CHAIN_CONTAINER__OUTGOING_TRACES);
		}
