...
public class FunctionOutputPortImpl extends FunctionPortImpl implements FunctionOutputPort {
	...
	/**
	 * The cached value of the '{@link #getOutgoingFunctionalExchanges() <em>Outgoing Functional Exchanges</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getOutgoingFunctionalExchanges()
	 * @generated
	 * @ordered
	 */
	protected EList<FunctionalExchange> outgoingFunctionalExchanges;
		...
		if (inActivityPartition != null && inActivityPartition.eIsProxy()) {
			...
			if (inActivityPartition != oldInActivityPartition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FaPackage.FUNCTION_OUTPUT_PORT__IN_ACTIVITY_PARTITION, oldInActivityPartition, inActivityPartition));
			}
		}
	...
	public InterruptibleActivityRegion getInInterruptibleRegion() {
		if (inInterruptibleRegion != null && inInterruptibleRegion.eIsProxy()) {
			...
			if (inInterruptibleRegion != oldInInterruptibleRegion) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FaPackage.FUNCTION_OUTPUT_PORT__IN_INTERRUPTIBLE_REGION, oldInInterruptibleRegion, inInterruptibleRegion));
			}
		}
	...
	public InterruptibleActivityRegion getInStructuredNode() {
		if (inStructuredNode != null && inStructuredNode.eIsProxy()) {
			...
			if (inStructuredNode != oldInStructuredNode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FaPackage.FUNCTION_OUTPUT_PORT__IN_STRUCTURED_NODE, oldInStructuredNode, inStructuredNode));
			}
		}
	...
	public EList<FunctionalExchange> getOutgoingFunctionalExchanges() {
		if (outgoingFunctionalExchanges == null) {
			outgoingFunctionalExchanges = new EObjectResolvingEList<FunctionalExchange>(FunctionalExchange.class, this, FaPackage.FUNCTION_OUTPUT_PORT__OUTGOING_FUNCTIONAL_EXCHANGES);
		}
		return outgoingFunctionalExchanges;
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case FaPackage.FUNCTION_OUTPUT_PORT__OUTGOING_FUNCTIONAL_EXCHANGES:
				return outgoingFunctionalExchanges != null && !outgoingFunctionalExchanges.isEmpty();
		}
