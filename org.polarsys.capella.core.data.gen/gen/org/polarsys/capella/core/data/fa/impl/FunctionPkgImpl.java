...
public abstract class FunctionPkgImpl extends NamedElementImpl implements FunctionPkg {
	...
	public EList<GenericTrace> getContainedGenericTraces() {
		if (containedGenericTraces == null) {
			containedGenericTraces = new EObjectResolvingEList<GenericTrace>(GenericTrace.class, this, FaPackage.FUNCTION_PKG__CONTAINED_GENERIC_TRACES);
		}
	...
	public EList<RequirementsTrace> getContainedRequirementsTraces() {
		if (containedRequirementsTraces == null) {
			containedRequirementsTraces = new EObjectResolvingEList<RequirementsTrace>(RequirementsTrace.class, this, FaPackage.FUNCTION_PKG__CONTAINED_REQUIREMENTS_TRACES);
		}
