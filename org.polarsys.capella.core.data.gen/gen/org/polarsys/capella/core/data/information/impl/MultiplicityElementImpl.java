...
public abstract class MultiplicityElementImpl extends ModelElementImpl implements MultiplicityElement {
	...
	public EList<AbstractTrace> getIncomingTraces() {
		if (incomingTraces == null) {
			incomingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, InformationPackage.MULTIPLICITY_ELEMENT__INCOMING_TRACES);
		}
	...
	public EList<AbstractTrace> getOutgoingTraces() {
		if (outgoingTraces == null) {
			outgoingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, InformationPackage.MULTIPLICITY_ELEMENT__OUTGOING_TRACES);
		}
