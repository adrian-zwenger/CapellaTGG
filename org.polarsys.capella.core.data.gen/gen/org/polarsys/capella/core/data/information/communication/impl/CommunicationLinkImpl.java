 ...
 *   <li>{@link org.polarsys.capella.core.data.information.communication.impl.CommunicationLinkImpl#getAppliedRequirements <em>Applied Requirements</em>}</li>
...
public class CommunicationLinkImpl extends ModelElementImpl implements CommunicationLink {
	...
	public EList<AbstractTrace> getIncomingTraces() {
		if (incomingTraces == null) {
			incomingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, CommunicationPackage.COMMUNICATION_LINK__INCOMING_TRACES);
		}
	...
	public EList<AbstractTrace> getOutgoingTraces() {
		if (outgoingTraces == null) {
			outgoingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, CommunicationPackage.COMMUNICATION_LINK__OUTGOING_TRACES);
		}
