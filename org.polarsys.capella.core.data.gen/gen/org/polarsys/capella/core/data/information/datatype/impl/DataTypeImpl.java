...
public abstract class DataTypeImpl extends GeneralizableElementImpl implements DataType {
	...
	/**
	 * The cached value of the '{@link #getRealizingDataTypes() <em>Realizing Data Types</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getRealizingDataTypes()
	 * @generated
	 * @ordered
	 */
	protected EList<DataType> realizingDataTypes;
	...
	public EList<DataType> getRealizedDataTypes() {
		if (realizedDataTypes == null) {
			realizedDataTypes = new EObjectWithInverseResolvingEList.ManyInverse<DataType>(DataType.class, this, DatatypePackage.DATA_TYPE__REALIZED_DATA_TYPES, DatatypePackage.DATA_TYPE__REALIZING_DATA_TYPES);
		}
	...
	public EList<DataType> getRealizingDataTypes() {
		if (realizingDataTypes == null) {
			realizingDataTypes = new EObjectWithInverseResolvingEList.ManyInverse<DataType>(DataType.class, this, DatatypePackage.DATA_TYPE__REALIZING_DATA_TYPES, DatatypePackage.DATA_TYPE__REALIZED_DATA_TYPES);
		}
		return realizingDataTypes;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DatatypePackage.DATA_TYPE__REALIZED_DATA_TYPES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getRealizedDataTypes()).basicAdd(otherEnd, msgs);
			case DatatypePackage.DATA_TYPE__REALIZING_DATA_TYPES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getRealizingDataTypes()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case DatatypePackage.DATA_TYPE__REALIZED_DATA_TYPES:
				return ((InternalEList<?>)getRealizedDataTypes()).basicRemove(otherEnd, msgs);
			case DatatypePackage.DATA_TYPE__REALIZING_DATA_TYPES:
				return ((InternalEList<?>)getRealizingDataTypes()).basicRemove(otherEnd, msgs);
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case DatatypePackage.DATA_TYPE__REALIZING_DATA_TYPES:
				return realizingDataTypes != null && !realizingDataTypes.isEmpty();
		}
