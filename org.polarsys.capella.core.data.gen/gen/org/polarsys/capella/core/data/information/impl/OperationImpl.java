...
public abstract class OperationImpl extends FeatureImpl implements Operation {
	...
	/**
	 * The cached value of the '{@link #getAllocatingOperations() <em>Allocating Operations</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAllocatingOperations()
	 * @generated
	 * @ordered
	 */
	protected EList<Operation> allocatingOperations;
	...
	public EList<AbstractTypedElement> getAbstractTypedElements() {
		if (abstractTypedElements == null) {
			abstractTypedElements = new EObjectResolvingEList<AbstractTypedElement>(AbstractTypedElement.class, this, InformationPackage.OPERATION__ABSTRACT_TYPED_ELEMENTS);
		}
	...
	public EList<SequenceMessage> getInvokingSequenceMessages() {
		if (invokingSequenceMessages == null) {
			invokingSequenceMessages = new EObjectResolvingEList<SequenceMessage>(SequenceMessage.class, this, InformationPackage.OPERATION__INVOKING_SEQUENCE_MESSAGES);
		}
	...
	public EList<Operation> getAllocatingOperations() {
		if (allocatingOperations == null) {
			allocatingOperations = new EObjectWithInverseResolvingEList.ManyInverse<Operation>(Operation.class, this, InformationPackage.OPERATION__ALLOCATING_OPERATIONS, InformationPackage.OPERATION__ALLOCATED_OPERATIONS);
		}
		return allocatingOperations;
	}
	...
	public EList<Operation> getAllocatedOperations() {
		if (allocatedOperations == null) {
			allocatedOperations = new EObjectWithInverseResolvingEList.ManyInverse<Operation>(Operation.class, this, InformationPackage.OPERATION__ALLOCATED_OPERATIONS, InformationPackage.OPERATION__ALLOCATING_OPERATIONS);
		}
	...
	public EList<ExchangeItem> getRealizedExchangeItems() {
		if (realizedExchangeItems == null) {
			realizedExchangeItems = new EObjectWithInverseResolvingEList.ManyInverse<ExchangeItem>(ExchangeItem.class, this, InformationPackage.OPERATION__REALIZED_EXCHANGE_ITEMS, InformationPackage.EXCHANGE_ITEM__REALIZING_OPERATIONS);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case InformationPackage.OPERATION__ALLOCATING_OPERATIONS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getAllocatingOperations()).basicAdd(otherEnd, msgs);
			case InformationPackage.OPERATION__ALLOCATED_OPERATIONS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getAllocatedOperations()).basicAdd(otherEnd, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case InformationPackage.OPERATION__ALLOCATING_OPERATIONS:
				return ((InternalEList<?>)getAllocatingOperations()).basicRemove(otherEnd, msgs);
			case InformationPackage.OPERATION__ALLOCATED_OPERATIONS:
				return ((InternalEList<?>)getAllocatedOperations()).basicRemove(otherEnd, msgs);
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case InformationPackage.OPERATION__ALLOCATING_OPERATIONS:
				return allocatingOperations != null && !allocatingOperations.isEmpty();
			case InformationPackage.OPERATION__ALLOCATED_OPERATIONS:
