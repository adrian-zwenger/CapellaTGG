...
public abstract class AbstractPhysicalInstanceImpl extends ModelElementImpl implements AbstractPhysicalInstance {
	...
	public EList<AbstractTrace> getIncomingTraces() {
		if (incomingTraces == null) {
			incomingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, DeploymentPackage.ABSTRACT_PHYSICAL_INSTANCE__INCOMING_TRACES);
		}
	...
	public EList<AbstractTrace> getOutgoingTraces() {
		if (outgoingTraces == null) {
			outgoingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, DeploymentPackage.ABSTRACT_PHYSICAL_INSTANCE__OUTGOING_TRACES);
		}
