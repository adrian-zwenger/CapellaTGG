...
public abstract class AbstractDependenciesPkgImpl extends NamedElementImpl implements AbstractDependenciesPkg {
	...
	public EList<GenericTrace> getContainedGenericTraces() {
		if (containedGenericTraces == null) {
			containedGenericTraces = new EObjectResolvingEList<GenericTrace>(GenericTrace.class, this, CapellacorePackage.ABSTRACT_DEPENDENCIES_PKG__CONTAINED_GENERIC_TRACES);
		}
	...
	public EList<RequirementsTrace> getContainedRequirementsTraces() {
		if (containedRequirementsTraces == null) {
			containedRequirementsTraces = new EObjectResolvingEList<RequirementsTrace>(RequirementsTrace.class, this, CapellacorePackage.ABSTRACT_DEPENDENCIES_PKG__CONTAINED_REQUIREMENTS_TRACES);
		}
