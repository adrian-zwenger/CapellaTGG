...
public abstract class GeneralizableElementImpl extends TypeImpl implements GeneralizableElement {
	...
	public EList<Generalization> getSuperGeneralizations() {
		if (superGeneralizations == null) {
			superGeneralizations = new EObjectEList<Generalization>(Generalization.class, this, CapellacorePackage.GENERALIZABLE_ELEMENT__SUPER_GENERALIZATIONS);
		}
	...
	public EList<Generalization> getSubGeneralizations() {
		if (subGeneralizations == null) {
			subGeneralizations = new EObjectResolvingEList<Generalization>(Generalization.class, this, CapellacorePackage.GENERALIZABLE_ELEMENT__SUB_GENERALIZATIONS);
		}
