...
public abstract class NamedElementImpl extends AbstractNamedElementImpl implements NamedElement {
	...
	public EList<AbstractTrace> getIncomingTraces() {
		if (incomingTraces == null) {
			incomingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, CapellacorePackage.NAMED_ELEMENT__INCOMING_TRACES);
		}
	...
	public EList<AbstractTrace> getOutgoingTraces() {
		if (outgoingTraces == null) {
			outgoingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, CapellacorePackage.NAMED_ELEMENT__OUTGOING_TRACES);
		}
