...
import modellingcore.impl.AbstractTypedElementImpl;
...
public abstract class TypedElementImpl extends AbstractTypedElementImpl implements TypedElement {
	...
	public EList<AbstractTrace> getIncomingTraces() {
		if (incomingTraces == null) {
			incomingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, CapellacorePackage.TYPED_ELEMENT__INCOMING_TRACES);
		}
	...
	public EList<AbstractTrace> getOutgoingTraces() {
		if (outgoingTraces == null) {
			outgoingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, CapellacorePackage.TYPED_ELEMENT__OUTGOING_TRACES);
		}
	...
	public EList<Requirement> getAppliedRequirements() {
		if (appliedRequirements == null) {
			appliedRequirements = new EObjectResolvingEList<Requirement>(Requirement.class, this, CapellacorePackage.TYPED_ELEMENT__APPLIED_REQUIREMENTS);
		}
