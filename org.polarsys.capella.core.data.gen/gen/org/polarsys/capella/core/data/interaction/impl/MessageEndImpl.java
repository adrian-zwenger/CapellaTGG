...
public class MessageEndImpl extends AbstractEndImpl implements MessageEnd {
	 ...
	 * @ordered
	 */
	protected SequenceMessage message;
	...
	public SequenceMessage getMessage() {
		if (message != null && message.eIsProxy()) {
			...
			message = (SequenceMessage)eResolveProxy(oldMessage);
			if (message != oldMessage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InteractionPackage.MESSAGE_END__MESSAGE, oldMessage, message));
			}
		}
		return message;
	}
