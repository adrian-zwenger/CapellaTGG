...
public class AbstractCapabilityExtendImpl extends RelationshipImpl implements AbstractCapabilityExtend {
	 ...
	 * @ordered
	 */
	protected AbstractCapability extension;
	...
	public AbstractCapability getExtension() {
		if (extension != null && extension.eIsProxy()) {
			...
			extension = (AbstractCapability)eResolveProxy(oldExtension);
			if (extension != oldExtension) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__EXTENSION, oldExtension, extension));
			}
		}
		return extension;
	}
