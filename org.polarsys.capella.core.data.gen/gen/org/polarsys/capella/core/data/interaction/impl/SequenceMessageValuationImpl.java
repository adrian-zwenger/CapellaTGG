...
public class SequenceMessageValuationImpl extends ModelElementImpl implements SequenceMessageValuation {
	...
	public EList<AbstractTrace> getIncomingTraces() {
		if (incomingTraces == null) {
			incomingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, InteractionPackage.SEQUENCE_MESSAGE_VALUATION__INCOMING_TRACES);
		}
	...
	public EList<AbstractTrace> getOutgoingTraces() {
		if (outgoingTraces == null) {
			outgoingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, InteractionPackage.SEQUENCE_MESSAGE_VALUATION__OUTGOING_TRACES);
		}
