...
public class AbstractCapabilityExtensionPointImpl extends RelationshipImpl implements AbstractCapabilityExtensionPoint {
	...
	/**
	 * The cached value of the '{@link #getAbstractCapability() <em>Abstract Capability</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected AbstractCapability abstractCapability;
	...
	public AbstractCapability getAbstractCapability() {
		if (abstractCapability != null && abstractCapability.eIsProxy()) {
			InternalEObject oldAbstractCapability = (InternalEObject)abstractCapability;
			abstractCapability = (AbstractCapability)eResolveProxy(oldAbstractCapability);
			if (abstractCapability != oldAbstractCapability) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InteractionPackage.ABSTRACT_CAPABILITY_EXTENSION_POINT__ABSTRACT_CAPABILITY, oldAbstractCapability, abstractCapability));
			}
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case InteractionPackage.ABSTRACT_CAPABILITY_EXTENSION_POINT__ABSTRACT_CAPABILITY:
				return abstractCapability != null;
			case InteractionPackage.ABSTRACT_CAPABILITY_EXTENSION_POINT__EXTEND_LINKS:
