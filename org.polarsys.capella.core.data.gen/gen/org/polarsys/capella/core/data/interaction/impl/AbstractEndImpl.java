...
public abstract class AbstractEndImpl extends InteractionFragmentImpl implements AbstractEnd {
	...
	public InstanceRole getCovered() {
		if (covered != null && covered.eIsProxy()) {
			...
			if (covered != oldCovered) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InteractionPackage.ABSTRACT_END__COVERED, oldCovered, covered));
			}
		}
		return covered;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCovered(InstanceRole newCovered, NotificationChain msgs) {
		InstanceRole oldCovered = covered;
		covered = newCovered;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, InteractionPackage.ABSTRACT_END__COVERED, oldCovered, newCovered);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case InteractionPackage.ABSTRACT_END__COVERED:
				if (covered != null)
					msgs = ((InternalEObject)covered).eInverseRemove(this, InteractionPackage.INSTANCE_ROLE__ABSTRACT_ENDS, InstanceRole.class, msgs);
				return basicSetCovered((InstanceRole)otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case InteractionPackage.ABSTRACT_END__COVERED:
				return basicSetCovered(null, msgs);
		}
