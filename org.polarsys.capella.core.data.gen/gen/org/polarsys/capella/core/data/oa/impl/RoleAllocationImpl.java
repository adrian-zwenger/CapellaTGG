...
public class RoleAllocationImpl extends AllocationImpl implements RoleAllocation {
		...
		if (role != null && role.eIsProxy()) {
			...
			if (role != oldRole) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OaPackage.ROLE_ALLOCATION__ROLE, oldRole, role));
			}
		}
		return role;
	}
	...
	public NotificationChain basicSetRole(Role newRole, NotificationChain msgs) {
		...
		role = newRole;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OaPackage.ROLE_ALLOCATION__ROLE, oldRole, newRole);
	...
	public Entity getEntity() {
		if (entity != null && entity.eIsProxy()) {
			...
			if (entity != oldEntity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OaPackage.ROLE_ALLOCATION__ENTITY, oldEntity, entity));
			}
		}
		return entity;
	}
	...
	public NotificationChain basicSetEntity(Entity newEntity, NotificationChain msgs) {
		...
		entity = newEntity;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OaPackage.ROLE_ALLOCATION__ENTITY, oldEntity, newEntity);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OaPackage.ROLE_ALLOCATION__ROLE:
				if (role != null)
					msgs = ((InternalEObject)role).eInverseRemove(this, OaPackage.ROLE__ROLE_ALLOCATIONS, Role.class, msgs);
				return basicSetRole((Role)otherEnd, msgs);
			case OaPackage.ROLE_ALLOCATION__ENTITY:
				if (entity != null)
					msgs = ((InternalEObject)entity).eInverseRemove(this, OaPackage.ENTITY__ROLE_ALLOCATIONS, Entity.class, msgs);
