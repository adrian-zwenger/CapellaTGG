...
public class OperationalAnalysisImpl extends BlockArchitectureImpl implements OperationalAnalysis {
	...
	/**
	 * The cached value of the '{@link #getContainedOperationalCapabilityPkg() <em>Contained Operational Capability Pkg</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getContainedOperationalActivityPkg() <em>Contained Operational Activity Pkg</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getAllocatingSystemAnalyses() <em>Allocating System Analyses</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAllocatingSystemAnalyses()
	 * @generated
	 * @ordered
	 */
	protected EList<SystemAnalysis> allocatingSystemAnalyses;
	...
	public OperationalCapabilityPkg getContainedOperationalCapabilityPkg() {
		if (containedOperationalCapabilityPkg != null && containedOperationalCapabilityPkg.eIsProxy()) {
			InternalEObject oldContainedOperationalCapabilityPkg = (InternalEObject)containedOperationalCapabilityPkg;
			containedOperationalCapabilityPkg = (OperationalCapabilityPkg)eResolveProxy(oldContainedOperationalCapabilityPkg);
			if (containedOperationalCapabilityPkg != oldContainedOperationalCapabilityPkg) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OaPackage.OPERATIONAL_ANALYSIS__CONTAINED_OPERATIONAL_CAPABILITY_PKG, oldContainedOperationalCapabilityPkg, containedOperationalCapabilityPkg));
			}
		}
	...
	public OperationalActivityPkg getContainedOperationalActivityPkg() {
		if (containedOperationalActivityPkg != null && containedOperationalActivityPkg.eIsProxy()) {
			InternalEObject oldContainedOperationalActivityPkg = (InternalEObject)containedOperationalActivityPkg;
			containedOperationalActivityPkg = (OperationalActivityPkg)eResolveProxy(oldContainedOperationalActivityPkg);
			if (containedOperationalActivityPkg != oldContainedOperationalActivityPkg) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OaPackage.OPERATIONAL_ANALYSIS__CONTAINED_OPERATIONAL_ACTIVITY_PKG, oldContainedOperationalActivityPkg, containedOperationalActivityPkg));
			}
		}
	...
	public EList<SystemAnalysis> getAllocatingSystemAnalyses() {
		if (allocatingSystemAnalyses == null) {
			allocatingSystemAnalyses = new EObjectWithInverseResolvingEList.ManyInverse<SystemAnalysis>(SystemAnalysis.class, this, OaPackage.OPERATIONAL_ANALYSIS__ALLOCATING_SYSTEM_ANALYSES, CtxPackage.SYSTEM_ANALYSIS__ALLOCATED_OPERATIONAL_ANALYSES);
		}
		return allocatingSystemAnalyses;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OaPackage.OPERATIONAL_ANALYSIS__ALLOCATING_SYSTEM_ANALYSES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getAllocatingSystemAnalyses()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case OaPackage.OPERATIONAL_ANALYSIS__ALLOCATING_SYSTEM_ANALYSES:
				return ((InternalEList<?>)getAllocatingSystemAnalyses()).basicRemove(otherEnd, msgs);
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case OaPackage.OPERATIONAL_ANALYSIS__ALLOCATING_SYSTEM_ANALYSES:
				return allocatingSystemAnalyses != null && !allocatingSystemAnalyses.isEmpty();
		}
