...
public class SwimlaneImpl extends NamedElementImpl implements Swimlane {
	...
	/**
	 * The cached value of the '{@link #getRepresentedEntity() <em>Represented Entity</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getRepresentedEntity()
	 * @generated
	 * @ordered
	 */
	protected Entity representedEntity;
	...
	public ActivityPartition getSuperPartition() {
		if (superPartition != null && superPartition.eIsProxy()) {
			...
			if (superPartition != oldSuperPartition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OaPackage.SWIMLANE__SUPER_PARTITION, oldSuperPartition, superPartition));
			}
		}
	...
	public EList<ActivityPartition> getSubPartitions() {
		if (subPartitions == null) {
			subPartitions = new EObjectResolvingEList<ActivityPartition>(ActivityPartition.class, this, OaPackage.SWIMLANE__SUB_PARTITIONS);
		}
	...
	public Entity getRepresentedEntity() {
		if (representedEntity != null && representedEntity.eIsProxy()) {
			InternalEObject oldRepresentedEntity = (InternalEObject)representedEntity;
			representedEntity = (Entity)eResolveProxy(oldRepresentedEntity);
			if (representedEntity != oldRepresentedEntity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OaPackage.SWIMLANE__REPRESENTED_ENTITY, oldRepresentedEntity, representedEntity));
			}
		}
