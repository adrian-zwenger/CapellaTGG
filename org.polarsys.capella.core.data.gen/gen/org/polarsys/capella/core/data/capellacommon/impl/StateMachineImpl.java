...
public class StateMachineImpl extends ModelElementImpl implements StateMachine {
	...
	public EList<AbstractTrace> getIncomingTraces() {
		if (incomingTraces == null) {
			incomingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, CapellacommonPackage.STATE_MACHINE__INCOMING_TRACES);
		}
	...
	public EList<AbstractTrace> getOutgoingTraces() {
		if (outgoingTraces == null) {
			outgoingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, CapellacommonPackage.STATE_MACHINE__OUTGOING_TRACES);
		}
