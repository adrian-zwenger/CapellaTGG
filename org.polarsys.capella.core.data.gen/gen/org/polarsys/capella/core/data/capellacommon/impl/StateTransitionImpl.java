...
public class StateTransitionImpl extends NamedElementImpl implements StateTransition {
	...
	/**
	 * The cached value of the '{@link #getRealizingStateTransitions() <em>Realizing State Transitions</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getRealizingStateTransitions()
	 * @generated
	 * @ordered
	 */
	protected EList<StateTransition> realizingStateTransitions;
	...
	public EList<StateTransition> getRealizingStateTransitions() {
		if (realizingStateTransitions == null) {
			realizingStateTransitions = new EObjectEList<StateTransition>(StateTransition.class, this, CapellacommonPackage.STATE_TRANSITION__REALIZING_STATE_TRANSITIONS);
		}
		return realizingStateTransitions;
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case CapellacommonPackage.STATE_TRANSITION__REALIZING_STATE_TRANSITIONS:
				return realizingStateTransitions != null && !realizingStateTransitions.isEmpty();
		}
