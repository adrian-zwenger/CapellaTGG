...
public class SharedPkgImpl extends NamedElementImpl implements SharedPkg {
	...
	public EList<GenericTrace> getContainedGenericTraces() {
		if (containedGenericTraces == null) {
			containedGenericTraces = new EObjectResolvingEList<GenericTrace>(GenericTrace.class, this, SharedmodelPackage.SHARED_PKG__CONTAINED_GENERIC_TRACES);
		}
	...
	public EList<RequirementsTrace> getContainedRequirementsTraces() {
		if (containedRequirementsTraces == null) {
			containedRequirementsTraces = new EObjectResolvingEList<RequirementsTrace>(RequirementsTrace.class, this, SharedmodelPackage.SHARED_PKG__CONTAINED_REQUIREMENTS_TRACES);
		}
