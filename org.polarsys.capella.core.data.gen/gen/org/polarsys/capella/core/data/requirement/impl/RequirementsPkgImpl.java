...
public class RequirementsPkgImpl extends NamedElementImpl implements RequirementsPkg {
	...
	public EList<GenericTrace> getContainedGenericTraces() {
		if (containedGenericTraces == null) {
			containedGenericTraces = new EObjectResolvingEList<GenericTrace>(GenericTrace.class, this, RequirementPackage.REQUIREMENTS_PKG__CONTAINED_GENERIC_TRACES);
		}
	...
	public EList<RequirementsTrace> getContainedRequirementsTraces() {
		if (containedRequirementsTraces == null) {
			containedRequirementsTraces = new EObjectResolvingEList<RequirementsTrace>(RequirementsTrace.class, this, RequirementPackage.REQUIREMENTS_PKG__CONTAINED_REQUIREMENTS_TRACES);
		}
