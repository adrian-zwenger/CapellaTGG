...
public class LogicalComponentImpl extends ComponentImpl implements LogicalComponent {
	...
	/**
	 * The cached value of the '{@link #getSubLogicalComponents() <em>Sub Logical Components</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getSubLogicalComponents()
	 * @generated
	 * @ordered
	 */
	protected EList<LogicalComponent> subLogicalComponents;
	...
	/**
	 * The cached value of the '{@link #getRealizedSystemComponents() <em>Realized System Components</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getRealizedSystemComponents()
	 * @generated
	 * @ordered
	 */
	protected EList<SystemComponent> realizedSystemComponents;

	/**
	 * The cached value of the '{@link #getRealizingPhysicalComponents() <em>Realizing Physical Components</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getRealizingPhysicalComponents()
	 * @generated
	 * @ordered
	 */
	protected EList<PhysicalComponent> realizingPhysicalComponents;
	...
	public EList<Involvement> getInvolvingInvolvements() {
		if (involvingInvolvements == null) {
			involvingInvolvements = new EObjectResolvingEList<Involvement>(Involvement.class, this, LaPackage.LOGICAL_COMPONENT__INVOLVING_INVOLVEMENTS);
		}
	...
	public EList<CapabilityRealizationInvolvement> getCapabilityRealizationInvolvements() {
		if (capabilityRealizationInvolvements == null) {
			capabilityRealizationInvolvements = new EObjectResolvingEList<CapabilityRealizationInvolvement>(CapabilityRealizationInvolvement.class, this, LaPackage.LOGICAL_COMPONENT__CAPABILITY_REALIZATION_INVOLVEMENTS);
		}
	...
	public EList<CapabilityRealization> getInvolvingCapabilityRealizations() {
		if (involvingCapabilityRealizations == null) {
			involvingCapabilityRealizations = new EObjectResolvingEList<CapabilityRealization>(CapabilityRealization.class, this, LaPackage.LOGICAL_COMPONENT__INVOLVING_CAPABILITY_REALIZATIONS);
		}
	...
	public EList<LogicalComponent> getSubLogicalComponents() {
		if (subLogicalComponents == null) {
			subLogicalComponents = new EObjectResolvingEList<LogicalComponent>(LogicalComponent.class, this, LaPackage.LOGICAL_COMPONENT__SUB_LOGICAL_COMPONENTS);
		}
		return subLogicalComponents;
	}
	...
	public EList<LogicalFunction> getAllocatedLogicalFunctions() {
		if (allocatedLogicalFunctions == null) {
			allocatedLogicalFunctions = new EObjectWithInverseResolvingEList.ManyInverse<LogicalFunction>(LogicalFunction.class, this, LaPackage.LOGICAL_COMPONENT__ALLOCATED_LOGICAL_FUNCTIONS, LaPackage.LOGICAL_FUNCTION__ALLOCATING_LOGICAL_COMPONENTS);
		}
	...
	public EList<SystemComponent> getRealizedSystemComponents() {
		if (realizedSystemComponents == null) {
			realizedSystemComponents = new EObjectResolvingEList<SystemComponent>(SystemComponent.class, this, LaPackage.LOGICAL_COMPONENT__REALIZED_SYSTEM_COMPONENTS);
		}
		return realizedSystemComponents;
	}
	...
	public EList<PhysicalComponent> getRealizingPhysicalComponents() {
		if (realizingPhysicalComponents == null) {
			realizingPhysicalComponents = new EObjectWithInverseResolvingEList.ManyInverse<PhysicalComponent>(PhysicalComponent.class, this, LaPackage.LOGICAL_COMPONENT__REALIZING_PHYSICAL_COMPONENTS, PaPackage.PHYSICAL_COMPONENT__REALIZED_LOGICAL_COMPONENTS);
		}
		return realizingPhysicalComponents;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LaPackage.LOGICAL_COMPONENT__ALLOCATED_LOGICAL_FUNCTIONS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getAllocatedLogicalFunctions()).basicAdd(otherEnd, msgs);
			case LaPackage.LOGICAL_COMPONENT__REALIZING_PHYSICAL_COMPONENTS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getRealizingPhysicalComponents()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case LaPackage.LOGICAL_COMPONENT__ALLOCATED_LOGICAL_FUNCTIONS:
				return ((InternalEList<?>)getAllocatedLogicalFunctions()).basicRemove(otherEnd, msgs);
			case LaPackage.LOGICAL_COMPONENT__REALIZING_PHYSICAL_COMPONENTS:
				return ((InternalEList<?>)getRealizingPhysicalComponents()).basicRemove(otherEnd, msgs);
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case LaPackage.LOGICAL_COMPONENT__SUB_LOGICAL_COMPONENTS:
				return subLogicalComponents != null && !subLogicalComponents.isEmpty();
			case LaPackage.LOGICAL_COMPONENT__ALLOCATED_LOGICAL_FUNCTIONS:
				return allocatedLogicalFunctions != null && !allocatedLogicalFunctions.isEmpty();
			case LaPackage.LOGICAL_COMPONENT__REALIZED_SYSTEM_COMPONENTS:
				return realizedSystemComponents != null && !realizedSystemComponents.isEmpty();
			case LaPackage.LOGICAL_COMPONENT__REALIZING_PHYSICAL_COMPONENTS:
				return realizingPhysicalComponents != null && !realizingPhysicalComponents.isEmpty();
		}
