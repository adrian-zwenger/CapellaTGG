...
public class PhysicalPortImpl extends PortImpl implements PhysicalPort {
	...
	public EList<ConfigurationItem> getAllocatorConfigurationItems() {
		if (allocatorConfigurationItems == null) {
			allocatorConfigurationItems = new EObjectWithInverseResolvingEList.ManyInverse<ConfigurationItem>(ConfigurationItem.class, this, CsPackage.PHYSICAL_PORT__ALLOCATOR_CONFIGURATION_ITEMS, EpbsPackage.CONFIGURATION_ITEM__ALLOCATED_PHYSICAL_ARTIFACTS);
		}
	...
	public EList<AbstractInformationFlow> getIncomingInformationFlows() {
		if (incomingInformationFlows == null) {
			incomingInformationFlows = new EObjectResolvingEList<AbstractInformationFlow>(AbstractInformationFlow.class, this, CsPackage.PHYSICAL_PORT__INCOMING_INFORMATION_FLOWS);
		}
	...
	public EList<AbstractInformationFlow> getOutgoingInformationFlows() {
		if (outgoingInformationFlows == null) {
			outgoingInformationFlows = new EObjectResolvingEList<AbstractInformationFlow>(AbstractInformationFlow.class, this, CsPackage.PHYSICAL_PORT__OUTGOING_INFORMATION_FLOWS);
		}
	...
	public EList<AbstractInformationFlow> getInformationFlows() {
		if (informationFlows == null) {
			informationFlows = new EObjectResolvingEList<AbstractInformationFlow>(AbstractInformationFlow.class, this, CsPackage.PHYSICAL_PORT__INFORMATION_FLOWS);
		}
	...
	public Type getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CsPackage.PHYSICAL_PORT__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public Association getAssociation() {
		if (association != null && association.eIsProxy()) {
			...
			if (association != oldAssociation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CsPackage.PHYSICAL_PORT__ASSOCIATION, oldAssociation, association));
			}
		}
		return association;
	}
	...
	public EList<ComponentPort> getAllocatedComponentPorts() {
		if (allocatedComponentPorts == null) {
			allocatedComponentPorts = new EObjectWithInverseResolvingEList.ManyInverse<ComponentPort>(ComponentPort.class, this, CsPackage.PHYSICAL_PORT__ALLOCATED_COMPONENT_PORTS, FaPackage.COMPONENT_PORT__ALLOCATING_PHYSICAL_PORTS);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case CsPackage.PHYSICAL_PORT__ALLOCATED_COMPONENT_PORTS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getAllocatedComponentPorts()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case CsPackage.PHYSICAL_PORT__ALLOCATED_COMPONENT_PORTS:
				return ((InternalEList<?>)getAllocatedComponentPorts()).basicRemove(otherEnd, msgs);
		}
