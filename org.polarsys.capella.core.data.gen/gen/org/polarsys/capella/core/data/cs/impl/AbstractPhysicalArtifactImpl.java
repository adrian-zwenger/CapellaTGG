...
public abstract class AbstractPhysicalArtifactImpl extends ModelElementImpl implements AbstractPhysicalArtifact {
	...
	public EList<AbstractTrace> getIncomingTraces() {
		if (incomingTraces == null) {
			incomingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, CsPackage.ABSTRACT_PHYSICAL_ARTIFACT__INCOMING_TRACES);
		}
	...
	public EList<AbstractTrace> getOutgoingTraces() {
		if (outgoingTraces == null) {
			outgoingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, CsPackage.ABSTRACT_PHYSICAL_ARTIFACT__OUTGOING_TRACES);
		}
	...
	public EList<ConfigurationItem> getAllocatorConfigurationItems() {
		if (allocatorConfigurationItems == null) {
			allocatorConfigurationItems = new EObjectWithInverseResolvingEList.ManyInverse<ConfigurationItem>(ConfigurationItem.class, this, CsPackage.ABSTRACT_PHYSICAL_ARTIFACT__ALLOCATOR_CONFIGURATION_ITEMS, EpbsPackage.CONFIGURATION_ITEM__ALLOCATED_PHYSICAL_ARTIFACTS);
		}
