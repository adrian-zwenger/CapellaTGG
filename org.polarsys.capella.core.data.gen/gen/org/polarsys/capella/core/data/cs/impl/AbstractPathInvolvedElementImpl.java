...
public abstract class AbstractPathInvolvedElementImpl extends ModelElementImpl implements AbstractPathInvolvedElement {
	...
	public EList<AbstractTrace> getIncomingTraces() {
		if (incomingTraces == null) {
			incomingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, CsPackage.ABSTRACT_PATH_INVOLVED_ELEMENT__INCOMING_TRACES);
		}
	...
	public EList<AbstractTrace> getOutgoingTraces() {
		if (outgoingTraces == null) {
			outgoingTraces = new EObjectResolvingEList<AbstractTrace>(AbstractTrace.class, this, CsPackage.ABSTRACT_PATH_INVOLVED_ELEMENT__OUTGOING_TRACES);
		}
	...
	public EList<Involvement> getInvolvingInvolvements() {
		if (involvingInvolvements == null) {
			involvingInvolvements = new EObjectResolvingEList<Involvement>(Involvement.class, this, CsPackage.ABSTRACT_PATH_INVOLVED_ELEMENT__INVOLVING_INVOLVEMENTS);
		}
