...
public abstract class BlockImpl extends TypeImpl implements Block {
	...
	public EList<ComponentFunctionalAllocation> getFunctionalAllocations() {
		if (functionalAllocations == null) {
			functionalAllocations = new EObjectWithInverseResolvingEList<ComponentFunctionalAllocation>(ComponentFunctionalAllocation.class, this, CsPackage.BLOCK__FUNCTIONAL_ALLOCATIONS, FaPackage.COMPONENT_FUNCTIONAL_ALLOCATION__BLOCK);
		}
	...
	public EList<AbstractFunction> getAllocatedFunctions() {
		if (allocatedFunctions == null) {
			allocatedFunctions = new EObjectWithInverseResolvingEList.ManyInverse<AbstractFunction>(AbstractFunction.class, this, CsPackage.BLOCK__ALLOCATED_FUNCTIONS, FaPackage.ABSTRACT_FUNCTION__ALLOCATION_BLOCKS);
		}
